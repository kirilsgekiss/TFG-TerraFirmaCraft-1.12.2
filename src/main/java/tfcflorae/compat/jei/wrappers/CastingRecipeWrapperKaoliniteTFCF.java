...
public class CastingRecipeWrapperKaoliniteTFCF implements IRecipeWrapper
{
    ...
    public CastingRecipeWrapperKaoliniteTFCF(Material material, OrePrefix orePrefix)
    {
        input = new FluidStack(material.getFluid(), ItemKaoliniteMold.get(orePrefix).moldCapacity);
