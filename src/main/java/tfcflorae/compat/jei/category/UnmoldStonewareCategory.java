...
public class UnmoldStonewareCategory extends BaseRecipeCategory<UnmoldRecipeWrapperStonewareTFCF> {
    ...
    @Override
    public void setRecipe(IRecipeLayout recipeLayout, UnmoldRecipeWrapperStonewareTFCF recipeWrapper, IIngredients ingredients)
    {
