...
{
    private static final HashMap<OrePrefix, ItemStonewareMold> MAP = new HashMap<>();

    public static ItemStonewareMold get(OrePrefix itemMold)
    {
    ...
    public ItemStonewareMold(OrePrefix type, int moldCapacity)
    {
        this.type = type;
    ...
    public String getItemStackDisplayName(ItemStack stack) {
        ...
        if (capFluidHandler instanceof IMaterialHandler)
        {
            ...
            if (material != null)
            {
                return LocalizationUtils.format("item.tfc.ceramics.fired.stoneware.mold.name", LocalizationUtils.format("item.material.oreprefix." + type.name, material.getLocalizedName()));
            }
        }
        return LocalizationUtils.format("item.tfc.ceramics.fired.stoneware.mold.empty.name", LocalizationUtils.format("item.material.oreprefix." + type.name + ".empty"));
    }
