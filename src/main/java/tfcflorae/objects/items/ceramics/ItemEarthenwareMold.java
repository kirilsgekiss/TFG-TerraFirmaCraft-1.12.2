...
public class ItemEarthenwareMold extends ItemPottery
{
    ...
    public String getItemStackDisplayName(ItemStack stack) {
        ...
        if (capFluidHandler instanceof IMaterialHandler)
        {
            ...
            if (material != null)
            {
                return LocalizationUtils.format("item.tfc.ceramics.fired.earthenware.mold.name", LocalizationUtils.format("item.material.oreprefix." + type.name, material.getLocalizedName()));
            }
        }
        return LocalizationUtils.format("item.tfc.ceramics.fired.earthenware.mold.empty.name", LocalizationUtils.format("item.material.oreprefix." + type.name + ".empty"));
    }
