...
public class ConfigTFCF
{
    ...
    @Config(modid = TFCFLORAE_MODID, category = "general", name = "TFCFlorae - General")
    @Config.LangKey("config." + TFCFLORAE_MODID + ".general")
    public static final class General
    {
        @Config.Comment("World generation settings")
        @Config.LangKey("config." + TFCFLORAE_MODID + ".general.world")
        public static final WorldCFG WORLD = new WorldCFG();

        @Config.Comment("Structure generation settings")
        @Config.LangKey("config." + TFCFLORAE_MODID + ".general.structures")
        ...
        public static final class WorldCFG
        {
            ...
            @Config.LangKey("config." + TFCFLORAE_MODID + ".general.world.humusRarity")
            ...
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + TFCFLORAE_MODID + ".general.world.podzolRarity")
            ...
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + TFCFLORAE_MODID + ".general.world.mudRarity")
            ...
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + TFCFLORAE_MODID + ".general.world.sandRarity")
            ...
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + TFCFLORAE_MODID + ".general.world.bogIronRarity")
            ...
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + TFCFLORAE_MODID + ".general.world.sparseGrassRarity")
            ...
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + TFCFLORAE_MODID + ".general.world.loamySandRarity")
            ...
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + TFCFLORAE_MODID + ".general.world.sandyLoamRarity")
            ...
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + TFCFLORAE_MODID + ".general.world.loamRarity")
            ...
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + TFCFLORAE_MODID + ".general.world.siltLoamRarity")
            ...
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + TFCFLORAE_MODID + ".general.world.siltRarity")
            ...
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + TFCFLORAE_MODID + ".general.world.sandyClayRarity")
            ...
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + TFCFLORAE_MODID + ".general.world.sandyClayLoamRarity")
            ...
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + TFCFLORAE_MODID + ".general.world.clayLoamRarity")
            ...
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + TFCFLORAE_MODID + ".general.world.siltyClayLoamRarity")
            ...
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + TFCFLORAE_MODID + ".general.world.siltyClayRarity")
            ...
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + TFCFLORAE_MODID + ".general.world.clayHumusRarity")
            ...
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + TFCFLORAE_MODID + ".general.world.earthenwareClayRarity")
            ...
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + TFCFLORAE_MODID + ".general.world.sandyEarthenwareClayRarity")
            ...
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + TFCFLORAE_MODID + ".general.world.sandyEarthenwareClayLoamRarity")
            ...
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + TFCFLORAE_MODID + ".general.world.earthenwareClayLoamRarity")
            ...
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + TFCFLORAE_MODID + ".general.world.siltyEarthenwareClayLoamRarity")
            ...
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + TFCFLORAE_MODID + ".general.world.siltyEarthenwareClayRarity")
            ...
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + TFCFLORAE_MODID + ".general.world.earthenwareClayHumusRarity")
            ...
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + TFCFLORAE_MODID + ".general.world.kaoliniteClayRarity")
            ...
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + TFCFLORAE_MODID + ".general.world.sandyKaoliniteClayRarity")
            ...
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + TFCFLORAE_MODID + ".general.world.sandyKaoliniteClayLoamRarity")
            ...
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + TFCFLORAE_MODID + ".general.world.kaoliniteClayLoamRarity")
            ...
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + TFCFLORAE_MODID + ".general.world.siltyKaoliniteClayLoamRarity")
            ...
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + TFCFLORAE_MODID + ".general.world.siltyKaoliniteClayRarity")
            ...
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + TFCFLORAE_MODID + ".general.world.kaoliniteClayHumusRarity")
            ...
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + TFCFLORAE_MODID + ".general.world.stonewareClayRarity")
            ...
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + TFCFLORAE_MODID + ".general.world.sandyStonewareClayRarity")
            ...
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + TFCFLORAE_MODID + ".general.world.sandyStonewareClayLoamRarity")
            ...
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + TFCFLORAE_MODID + ".general.world.stonewareClayLoamRarity")
            ...
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + TFCFLORAE_MODID + ".general.world.siltyStonewareClayLoamRarity")
            ...
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + TFCFLORAE_MODID + ".general.world.siltyStonewareClayRarity")
            ...
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + TFCFLORAE_MODID + ".general.world.stonewareClayHumusRarity")
            ...
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + TFCFLORAE_MODID + ".general.world.coarseDirtRarity")
            ...
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + TFCFLORAE_MODID + ".general.world.coarseLoamySandRarity")
            ...
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + TFCFLORAE_MODID + ".general.world.coarseSandyLoamRarity")
            ...
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + TFCFLORAE_MODID + ".general.world.coarseLoamRarity")
            ...
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + TFCFLORAE_MODID + ".general.world.coarseSiltLoamRarity")
            ...
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + TFCFLORAE_MODID + ".general.world.coarseSiltRarity")
            ...
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + TFCFLORAE_MODID + ".general.world.coarseHumusRarity")
            ...
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + TFCFLORAE_MODID + ".general.world.rootedDirtRarity")
            ...
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + TFCFLORAE_MODID + ".general.world.rootedLoamySandRarity")
            ...
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + TFCFLORAE_MODID + ".general.world.rootedSandyLoamRarity")
            ...
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + TFCFLORAE_MODID + ".general.world.rootedLoamRarity")
            ...
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + TFCFLORAE_MODID + ".general.world.rootedSiltLoamRarity")
            ...
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + TFCFLORAE_MODID + ".general.world.rootedSiltRarity")
            ...
            @Config.RangeDouble(min = 0)
            @Config.LangKey("config." + TFCFLORAE_MODID + ".general.world.fungiUndergroundCount")
            ...
            @Config.RangeDouble(min = 0)
            @Config.LangKey("config." + TFCFLORAE_MODID + ".general.world.hangingVinesUndergroundCount")
            ...
            @Config.RangeDouble(min = 0)
            @Config.LangKey("config." + TFCFLORAE_MODID + ".general.world.creepingVinesUndergroundCount")
            ...
            @Config.RangeDouble(min = 0)
            @Config.LangKey("config." + TFCFLORAE_MODID + ".general.world.creepingUndergroundCount")
            ...
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + TFCFLORAE_MODID + ".general.world.bambooRarity")
            ...
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + TFCFLORAE_MODID + ".general.world.cinnamonRarity")
            ...
            @Config.LangKey("config." + TFCFLORAE_MODID + ".general.world.enableGroundcoverOreDeposit")
            public boolean enableGroundcoverOreDeposit = true;

            @Config.Comment("Enable pinecone groundcover?")
            @Config.LangKey("config." + TFCFLORAE_MODID + ".general.world.enableGroundcoverPinecone")
        ...
        public static final class StructuresCFG
        {
            ...
            @Config.LangKey("config." + TFCFLORAE_MODID + ".general.structures.activateStructureGeneration")
            ...
            @Config.LangKey("config." + TFCFLORAE_MODID + ".general.structures.generationModifier")
            ...
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + TFCFLORAE_MODID + ".general.structures.spawnChanceRuins")
            ...
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + TFCFLORAE_MODID + ".general.structures.spawnChanceMoai")
            ...
            @Config.RangeInt(min = 1)
            @Config.LangKey("config." + TFCFLORAE_MODID + ".general.structures.spawnChanceMaya")
