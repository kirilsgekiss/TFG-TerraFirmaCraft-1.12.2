...
public class RenderQuailTFC extends RenderLiving<TFCEntityQuail>
{
    ...
    @Override
    public void doRender(TFCEntityQuail quail, double par2, double par4, double par6, float par8, float par9)
    {
    ...
    @Override
    protected ResourceLocation getEntityTexture(TFCEntityQuail quail)
    {
    ...
    @Override
    protected float handleRotationFloat(TFCEntityQuail livingBase, float partialTicks)
    {
    ...
    @Override
    protected void preRenderCallback(TFCEntityQuail quail, float par2)
    {
