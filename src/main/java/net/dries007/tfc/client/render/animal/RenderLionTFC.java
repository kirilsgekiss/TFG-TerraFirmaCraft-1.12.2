...
public class RenderLionTFC extends RenderLiving<TFCEntityLion> {
    ...
    @Override
    public void doRender(TFCEntityLion lion, double par2, double par4, double par6, float par8, float par9) {
        this.shadowSize = (float) (0.4f + lion.getPercentToAdulthood() * 0.4f);
        super.doRender(lion, par2, par4, par6, par8, par9);
    }

    protected void preRenderCallback(TFCEntityLion lionTFC, float par2) {
        GlStateManager.scale(1.1f, 1.1f, 1.1f);
    }


    protected ResourceLocation getEntityTexture(TFCEntityLion lion) {
