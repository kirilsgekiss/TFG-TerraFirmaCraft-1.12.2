...
public class RenderThrownJavelin extends RenderThrownWeapon<TFCEntityThrownJavelin> {
    public RenderThrownJavelin(RenderManager renderManagerIn) {
        super(renderManagerIn);
    }

    @Override
    protected void doRenderTransformations(TFCEntityThrownJavelin entity, float partialTicks) {
