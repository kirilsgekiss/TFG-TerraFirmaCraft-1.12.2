...
public class RenderMongooseTFC extends RenderLiving<TFCEntityMongoose> {
    ...
    @Override
    public void doRender(@Nonnull TFCEntityMongoose mongoose, double par2, double par4, double par6, float par8, float par9) {
        this.shadowSize = (float) (0.35f + (mongoose.getPercentToAdulthood() * 0.35f));
        super.doRender(mongoose, par2, par4, par6, par8, par9);
    }

    @Override
    protected ResourceLocation getEntityTexture(TFCEntityMongoose entity) {
        return TEXTURE;
    }
}
