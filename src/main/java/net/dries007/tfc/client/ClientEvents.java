...
import net.dries007.tfc.client.render.TFCRenderBoat;
...
public class ClientEvents {
    public static void preInit() {
        ...
        RenderingRegistry.registerEntityRenderingHandler(TFCEntityChicken.class, RenderChickenTFC::new);
        RenderingRegistry.registerEntityRenderingHandler(TFCEntityPheasant.class, RenderPheasantTFC::new);
        RenderingRegistry.registerEntityRenderingHandler(TFCEntityDeer.class, RenderDeerTFC::new);
        RenderingRegistry.registerEntityRenderingHandler(TFCEntityPig.class, RenderPigTFC::new);
        RenderingRegistry.registerEntityRenderingHandler(TFCEntityWolf.class, RenderWolfTFC::new);
        RenderingRegistry.registerEntityRenderingHandler(TFCEntityRabbit.class, RenderRabbitTFC::new);
        ...
        RenderingRegistry.registerEntityRenderingHandler(TFCEntityOcelot.class, RenderOcelotTFC::new);
        RenderingRegistry.registerEntityRenderingHandler(TFCEntityPanther.class, RenderPantherTFC::new);
        RenderingRegistry.registerEntityRenderingHandler(TFCEntityDuck.class, RenderDuckTFC::new);
        RenderingRegistry.registerEntityRenderingHandler(TFCEntityAlpaca.class, RenderAlpacaTFC::new);
        RenderingRegistry.registerEntityRenderingHandler(TFCEntityGoat.class, RenderGoatTFC::new);
        RenderingRegistry.registerEntityRenderingHandler(TFCEntitySaberTooth.class, RenderSaberToothTFC::new);
        RenderingRegistry.registerEntityRenderingHandler(TFCEntityCamel.class, RenderCamelTFC::new);
        RenderingRegistry.registerEntityRenderingHandler(TFCEntityLion.class, RenderLionTFC::new);
        RenderingRegistry.registerEntityRenderingHandler(TFCEntityHyena.class, RenderHyenaTFC::new);
        RenderingRegistry.registerEntityRenderingHandler(TFCEntityDireWolf.class, RenderDireWolfTFC::new);
        RenderingRegistry.registerEntityRenderingHandler(TFCEntityHare.class, RenderHareTFC::new);
        RenderingRegistry.registerEntityRenderingHandler(TFCEntityBoar.class, RenderBoarTFC::new);
        RenderingRegistry.registerEntityRenderingHandler(TFCEntityZebu.class, RenderZebuTFC::new);
        RenderingRegistry.registerEntityRenderingHandler(TFCEntityGazelle.class, RenderGazelleTFC::new);
        RenderingRegistry.registerEntityRenderingHandler(TFCEntityWildebeest.class, RenderWildebeestTFC::new);
        RenderingRegistry.registerEntityRenderingHandler(TFCEntityQuail.class, RenderQuailTFC::new);
        RenderingRegistry.registerEntityRenderingHandler(TFCEntityGrouse.class, RenderGrouseTFC::new);
        RenderingRegistry.registerEntityRenderingHandler(TFCEntityMongoose.class, RenderMongooseTFC::new);
        RenderingRegistry.registerEntityRenderingHandler(TFCEntityTurkey.class, RenderTurkeyTFC::new);
        RenderingRegistry.registerEntityRenderingHandler(TFCEntityJackal.class, RenderJackalTFC::new);
        RenderingRegistry.registerEntityRenderingHandler(TFCEntityMuskOx.class, RenderMuskOxTFC::new);
        RenderingRegistry.registerEntityRenderingHandler(TFCEntityYak.class, RenderYakTFC::new);
        RenderingRegistry.registerEntityRenderingHandler(TFCEntityBlackBear.class, RenderBlackBearTFC::new);
        RenderingRegistry.registerEntityRenderingHandler(TFCEntityCougar.class, RenderCougarTFC::new);
        RenderingRegistry.registerEntityRenderingHandler(TFCEntityCoyote.class, RenderCoyoteTFC::new);
        RenderingRegistry.registerEntityRenderingHandler(TFCEntitySilkMoth.class, RendererSilkMoth.FACTORY);
    }
