...
public class TFCEntityCamel extends TFCEntityLlama implements IAnimalTFC, ILivestock, IRidable {
    private static final DataParameter<Integer> DATA_COLOR_ID = EntityDataManager.createKey(TFCEntityCamel.class, DataSerializers.VARINT);
    ...
    public TFCEntityCamel(World world, IAnimalTFC.Gender gender, int birthDay) {
    ...
    public void onFertilized(@Nonnull IAnimalTFC male) {
        ...
        if (selection < 4) {
            ...
            i = ((TFCEntityCamel) male).getVariant();
        } else {
            // Mutation
            i = this.rand.nextInt(4);
        }
        this.geneVariant = i;
        TFCEntityCamel father = (TFCEntityCamel) male;
    ...
    public boolean canMateWith(EntityAnimal otherAnimal) {
        ...
        TFCEntityCamel other = (TFCEntityCamel) otherAnimal;
        return this.getGender() != other.getGender() && this.isInLove() && other.isInLove();
    }

    @Nullable
    @Override
    public TFCEntityCamel createChild(@Nonnull EntityAgeable other) {
