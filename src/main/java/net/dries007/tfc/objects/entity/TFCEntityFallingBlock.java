...
public class TFCEntityFallingBlock extends EntityFallingBlock implements IEntityAdditionalSpawnData {
    ...
    public TFCEntityFallingBlock(World world) {
        super(world);
    }

    public TFCEntityFallingBlock(World world, BlockPos pos, IBlockState fallingBlockState) {
        this(world, pos.getX(), pos.getY(), pos.getZ(), fallingBlockState);
    }

    public TFCEntityFallingBlock(World world, double x, double y, double z, IBlockState fallingBlockState) {
        super(world);
    ...
    public void fall(float distance, float damageMultiplier) {
        ...
        for (Entity entity : list) {
            if (TFCConfig.General.FALLABLE.hurtEntities && distance > 1.0F && entity instanceof EntityLivingBase) {
                entity.attackEntityFrom(DamageSource.FALLING_BLOCK, distance);
            } else if (TFCConfig.General.FALLABLE.destroyItems && entity instanceof EntityItem) {
                entity.setDead();
            }
        }
    }
