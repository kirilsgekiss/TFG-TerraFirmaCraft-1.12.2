...
public class TFCEntityThrownWeapon extends EntityArrow implements IThrowableEntity, IEntityAdditionalSpawnData {
    private ItemStack weapon = ItemStack.EMPTY;
    private int knockbackStrength = 0;

    protected TFCEntityThrownWeapon(World world) {
        super(world);
    }

    protected TFCEntityThrownWeapon(World world, double x, double y, double z) {
        super(world, x, y, z);
    }

    protected TFCEntityThrownWeapon(World world, EntityLivingBase shooter) {
        super(world, shooter);
    }
