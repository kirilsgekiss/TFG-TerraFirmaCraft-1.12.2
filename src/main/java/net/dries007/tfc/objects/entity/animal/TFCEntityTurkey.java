...
public class TFCEntityTurkey extends TFCEntityAnimal implements IHuntable
{
    ...
    public TFCEntityTurkey(World worldIn)
    {
        this(worldIn, Gender.valueOf(Constants.RNG.nextBoolean()), getRandomGrowth(DAYS_TO_ADULTHOOD, 0));
    }

    public TFCEntityTurkey(World worldIn, Gender gender, int birthDay)
    {
