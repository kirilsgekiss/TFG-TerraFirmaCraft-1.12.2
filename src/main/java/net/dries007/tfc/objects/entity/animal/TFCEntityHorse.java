...
public class TFCEntityHorse extends EntityHorse implements IAnimalTFC, ILivestock, IRidable {
    //Values that has a visual effect on client
    private static final DataParameter<Boolean> GENDER = EntityDataManager.createKey(TFCEntityHorse.class, DataSerializers.BOOLEAN);
    private static final DataParameter<Integer> BIRTHDAY = EntityDataManager.createKey(TFCEntityHorse.class, DataSerializers.VARINT);
    private static final DataParameter<Float> FAMILIARITY = EntityDataManager.createKey(TFCEntityHorse.class, DataSerializers.FLOAT);
    ...
    protected void initEntityAI() {
        ...
        tasks.addTask(2, new EntityAIMate(this, 1.0D, TFCEntityDonkey.class)); // Missing donkeys (for mules)
