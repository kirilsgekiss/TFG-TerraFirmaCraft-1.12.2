 ...
 */
public class TFCEntityAIAttackMelee<T extends EntityCreature & IAnimalTFC> extends EntityAIAttackMelee {
    ...
    public TFCEntityAIAttackMelee(T creature, double speed, double attackReach) {
        this(creature, speed, attackReach, AttackBehavior.EVERYTIME);
    }

    public TFCEntityAIAttackMelee(T creature, double speed, double attackReach, AttackBehavior attackBehavior) {
     ...
     */
    public TFCEntityAIAttackMelee<T> setWanderAI(EntityAIWander wander) {
        this.wander = wander;
        return this;
    }
