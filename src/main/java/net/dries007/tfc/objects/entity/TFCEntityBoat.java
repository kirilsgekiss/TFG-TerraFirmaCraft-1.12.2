...
public class TFCEntityBoat extends EntityBoat {
    private static final DataParameter<String> WOOD_NAME = EntityDataManager.createKey(TFCEntityBoat.class, DataSerializers.STRING);

    public TFCEntityBoat(World worldIn) {
        super(worldIn);
    }

    public TFCEntityBoat(World worldIn, double x, double y, double z) {
        super(worldIn, x, y, z);
    }
