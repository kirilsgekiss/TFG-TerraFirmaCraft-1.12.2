...
public class TFCEntityLlama extends EntityLlama implements IAnimalTFC, ILivestock
{
    //Values that has a visual effect on client
    protected static final DataParameter<Boolean> GENDER = EntityDataManager.createKey(TFCEntityLlama.class, DataSerializers.BOOLEAN);
    protected static final DataParameter<Integer> BIRTHDAY = EntityDataManager.createKey(TFCEntityLlama.class, DataSerializers.VARINT);
    protected static final DataParameter<Float> FAMILIARITY = EntityDataManager.createKey(TFCEntityLlama.class, DataSerializers.FLOAT);
    ...
    public void onFertilized(@Nonnull IAnimalTFC male)
    {
        ...
        {
            i = ((TFCEntityLlama) male).getVariant();
        }
        else
        {
            // Mutation
        ...
        this.geneVariant = i;
        TFCEntityLlama father = (TFCEntityLlama) male;
    ...
    public boolean canMateWith(EntityAnimal otherAnimal)
    {
        ...
        TFCEntityLlama other = (TFCEntityLlama) otherAnimal;
