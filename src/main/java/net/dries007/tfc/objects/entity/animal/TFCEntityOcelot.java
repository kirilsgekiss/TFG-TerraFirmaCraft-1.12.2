...
public class TFCEntityOcelot extends EntityOcelot implements IAnimalTFC, ILivestock
{
    //Values that has a visual effect on client
    private static final DataParameter<Boolean> GENDER = EntityDataManager.createKey(TFCEntityOcelot.class, DataSerializers.BOOLEAN);
    private static final DataParameter<Integer> BIRTHDAY = EntityDataManager.createKey(TFCEntityOcelot.class, DataSerializers.VARINT);
    private static final DataParameter<Float> FAMILIARITY = EntityDataManager.createKey(TFCEntityOcelot.class, DataSerializers.FLOAT);
    ...
    @Nullable
    @Override
    public TFCEntityOcelot createChild(@Nonnull EntityAgeable other)
    {
    ...
    public boolean canMateWith(EntityAnimal otherAnimal)
    {
        ...
        TFCEntityOcelot other = (TFCEntityOcelot) otherAnimal;
