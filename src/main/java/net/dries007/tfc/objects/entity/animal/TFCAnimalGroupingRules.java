 ...
 */
public enum TFCAnimalGroupingRules implements BiConsumer<List<EntityLiving>, Random> {
                    ...
                    for (int i = 0; i < entityLivings.size(); i++) {
                        ...
                        if (living instanceof IAnimalTFC) {
                            ...
                            if (i == 0) {
                                ...
                                animal.setBirthDay((int) (TFCCalendar.PLAYER_TIME.getTotalDays() - lifeTimeDays));
                            } else {
                                // Children
