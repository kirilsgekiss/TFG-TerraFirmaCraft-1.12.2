...
public class ItemKaoliniteMold extends ItemPottery {
    private static final HashMap<OrePrefix, ItemKaoliniteMold> MAP = new HashMap<>();

    public static ItemKaoliniteMold get(OrePrefix itemMold) {
    ...
    public ItemKaoliniteMold(OrePrefix type, int moldCapacity) {
        this.type = type;
    ...
    public String getItemStackDisplayName(ItemStack stack) {
        ...
        if (capFluidHandler instanceof IMaterialHandler) {
            ...
            if (material != null) {
                return LocalizationUtils.format("item.tfc.ceramics.kaolinite.fired.mold.name", LocalizationUtils.format("item.material.oreprefix." + type.name, material.getLocalizedName()));
            }
        }
        return LocalizationUtils.format("item.tfc.ceramics.kaolinite.fired.mold.empty.name", LocalizationUtils.format("item.material.oreprefix." + type.name + ".empty"));
    }
