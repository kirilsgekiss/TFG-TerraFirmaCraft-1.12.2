...
public class TFCItemBrick extends TFCItem implements IRockObject {
    private static final Map<Rock, TFCItemBrick> MAP = new HashMap<>();

    public static TFCItemBrick get(Rock ore) {
        return MAP.get(ore);
    }
