                    ...
                    if (onlySmeltables)
                    {
                        ...
                        for (Entry<Material, Integer> entry : materials.entrySet())
                        {
                            ...
                            if (key != null)
                            {
                                ...
                                text.add(textPosition, I18n.format(TerraFirmaCraft.MOD_ID + ".tooltip.small_vessel_unit_total", I18n.format(key.getUnlocalizedName()), metalAmount, Math.round((float) metalAmount / totalAmount * 1000) / 10f));
                            }
                        }
