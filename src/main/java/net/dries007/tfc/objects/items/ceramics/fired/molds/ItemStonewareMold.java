...
public class ItemStonewareMold extends ItemPottery {
    ...
    public String getItemStackDisplayName(ItemStack stack) {
        ...
        if (capFluidHandler instanceof IMaterialHandler) {
            ...
            if (material != null) {
                return LocalizationUtils.format("item.tfc.ceramics.stoneware.fired.mold.name", LocalizationUtils.format("item.material.oreprefix." + type.name, material.getLocalizedName()));
            }
        }
        return LocalizationUtils.format("item.tfc.ceramics.stoneware.fired.mold.empty.name", LocalizationUtils.format("item.material.oreprefix." + type.name + ".empty"));
    }
