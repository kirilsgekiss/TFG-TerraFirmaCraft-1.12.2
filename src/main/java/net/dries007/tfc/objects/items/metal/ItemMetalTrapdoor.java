...
import net.dries007.tfc.objects.blocks.metal.BlockTrapDoorTFC;
...
public class ItemMetalTrapdoor extends ItemTFC implements IMetalItem {
        ...
        if (facing != null)
        {
                    ...
                    stateSupport.isSideSolid(worldIn, supportPos, EnumFacing.UP)) //forge says to do it this way, IBlockProperties#isTopSolid
            {
                if (!worldIn.isRemote)
                {
                    ...
                    worldIn.setBlockState(placedPos, BlockTrapDoorTFC.get(trapdoor.material).getDefaultState());
