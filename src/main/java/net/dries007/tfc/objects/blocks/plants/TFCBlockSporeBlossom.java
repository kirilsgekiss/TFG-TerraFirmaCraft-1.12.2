...
public class TFCBlockSporeBlossom extends TFCBlockPlantDummy1
{
    ...
    private static final Map<Plant, TFCBlockSporeBlossom> MAP = new HashMap<>();

    public static TFCBlockSporeBlossom get(Plant plant)
    {
        return MAP.get(plant);
    }

    public TFCBlockSporeBlossom(Plant plant)
    {
        super(plant);
    ...
    public void randomDisplayTick(IBlockState state, World worldIn, BlockPos pos, Random random)
    {
        ...
        TFCParticles.FALLING_BLOSSOM.spawn(worldIn, d0, d1, d2, 0.0D, 0.0D, 0.0D, (int)(64 / (Math.random() * 0.9D + 0.1D)));
        ...
        for (int l = 0; l < 14; ++l)
        {
            ...
            {
                TFCParticles.BLOSSOM.spawn(worldIn, (double)blockPos$mutableBlockPos.getX() + random.nextDouble(), (double)blockPos$mutableBlockPos.getY() + random.nextDouble(), (double)blockPos$mutableBlockPos.getZ() + random.nextDouble(), 0.0D, 0.0D, 0.0D, (random.nextInt(1000 - 500) + 500));
            }
        }
    }
}
