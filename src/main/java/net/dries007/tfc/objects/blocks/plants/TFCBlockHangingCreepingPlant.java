...
public class TFCBlockHangingCreepingPlant extends TFCBlockCreepingPlant implements IGrowable
{
    private static final PropertyBool BOTTOM = PropertyBool.create("bottom");
    private static final Map<Plant, TFCBlockHangingCreepingPlant> MAP = new HashMap<>();

    public static TFCBlockHangingCreepingPlant get(Plant plant)
    {
        return TFCBlockHangingCreepingPlant.MAP.get(plant);
    }

    public TFCBlockHangingCreepingPlant(Plant plant)
    {
        super(plant);
