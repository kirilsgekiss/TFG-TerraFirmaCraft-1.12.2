...
public class TFCBlockShortGrass extends TFCBlockPlant implements IShearable {
    ...
    private static final Map<Plant, TFCBlockShortGrass> MAP = new HashMap<>();

    public static TFCBlockShortGrass get(Plant plant) {
        return TFCBlockShortGrass.MAP.get(plant);
    }

    public TFCBlockShortGrass(Plant plant) {
        super(plant);
