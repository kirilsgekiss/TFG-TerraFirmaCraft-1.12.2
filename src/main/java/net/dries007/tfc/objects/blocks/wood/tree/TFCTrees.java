...
import net.dries007.tfc.world.classic.worldgen.trees.dt.TreeFamilyDynamic;
...
{
    public static ArrayList<TreeFamilyDynamic> tfcTrees = new ArrayList<>();
    ...
    public static void registerBlocks(IForgeRegistry<Block> registry)
    {
        ...
        for (Tree t1 : TFCRegistries.TREES.getValuesCollection())
        {
            ...
            TreeFamilyDynamic family = new TreeFamilyDynamic(resLoc, t1);
            ...
            treeBlocks.add(new BlockLogDynamic(t1).setRegistryName(MOD_ID, "block/log/" + treeName));
        }
    ...
    public static void registerItems(IForgeRegistry<Item> registry) //has to wait until TFC Items have been registered
    {
        TFCRegistries.TREES.getValuesCollection().forEach(t -> {
            ...
            ((TreeFamilyDynamic) tfcSpecies.get(treeName).getFamily()).setPrimitiveLog(BlockLogDynamic.get(t).getDefaultState());
        });
    }
