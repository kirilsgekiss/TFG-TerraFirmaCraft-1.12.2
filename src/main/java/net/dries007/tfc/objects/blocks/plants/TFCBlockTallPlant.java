...
public class TFCBlockTallPlant extends TFCBlockPlant implements IGrowable, ITallPlant {
    private static final PropertyEnum<EnumBlockPart> PART = PropertyEnum.create("part", EnumBlockPart.class);
    private static final Map<Plant, TFCBlockTallPlant> MAP = new HashMap<>();

    public static TFCBlockTallPlant get(Plant plant) {
        return TFCBlockTallPlant.MAP.get(plant);
    }

    public TFCBlockTallPlant(Plant plant) {
        super(plant);
