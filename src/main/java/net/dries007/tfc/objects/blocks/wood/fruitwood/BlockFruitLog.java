...
public class BlockFruitLog extends BlockLog implements IItemSize
{
    ...
    private static final Map<SeasonalTrees, BlockFruitLog> MAP = new HashMap<>();
    private static final Map<Tree, BlockFruitLog> MAP_TREE = new HashMap<>();

    public static BlockFruitLog get(SeasonalTrees tree)
    {
        return MAP.get(tree);
    }
    
    public static BlockFruitLog get(Tree wood)
    {
    ...
    public BlockFruitLog(Tree wood, SeasonalTrees tree)
    {
        this.wood = wood;
        this.fruitTree = tree;
