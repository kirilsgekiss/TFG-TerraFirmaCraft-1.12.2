...
public class TFCBlockWoodSupport extends Block {
    ...
    private boolean isThreeTall(IBlockAccess world, BlockPos pos) {
        ...
        if (!(world.getBlockState(pos.down()).getBlock() instanceof TFCBlockWoodSupport)) return false;
        return world.getBlockState(pos.down().down()).getBlock() instanceof TFCBlockWoodSupport;
    }
