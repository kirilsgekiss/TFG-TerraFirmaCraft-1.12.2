...
public class TFCBlockTallWaterPlant extends TFCBlockWaterPlant implements IGrowable, ITallPlant {
    private static final PropertyEnum<EnumBlockPart> PART = PropertyEnum.create("part", EnumBlockPart.class);
    private static final Map<Plant, TFCBlockTallWaterPlant> MAP = new HashMap<>();

    public static TFCBlockTallWaterPlant get(Plant plant) {
        return MAP.get(plant);
    }

    public TFCBlockTallWaterPlant(Plant plant) {
        super(plant);
