...
public class TFCBlockHangingPlant extends TFCBlockPlantDummy1 implements IGrowable, ITallPlant {
    ...
    private static final Map<Plant, TFCBlockHangingPlant> MAP = new HashMap<>();

    public static TFCBlockHangingPlant get(Plant plant) {
        return MAP.get(plant);
    }

    public TFCBlockHangingPlant(Plant plant) {
        super(plant);
