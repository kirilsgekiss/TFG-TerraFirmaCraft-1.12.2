package net.dries007.tfc.objects.blocks.rock.farmland;
...
public class TFCBlockFarmlandSilt extends TFCBlockFarmland {
    ...
    public TFCBlockFarmlandSilt(Type rockTFCF, Rock rock) {
        super(rockTFCF, rock);
    ...
    public Item getItemDropped(IBlockState state, Random rand, int fortune) {
        return Item.getItemFromBlock(get(rock, Type.SILT));
    }

    private void turnToDirt(World world, BlockPos pos) {
        world.setBlockState(pos, get(rock, Type.SILT).getDefaultState());
