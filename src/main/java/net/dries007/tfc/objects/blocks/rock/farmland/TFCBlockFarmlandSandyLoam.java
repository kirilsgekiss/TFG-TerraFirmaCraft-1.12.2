...
public class TFCBlockFarmlandSandyLoam extends TFCBlockFarmland {
    ...
    public TFCBlockFarmlandSandyLoam(Type rockTFCF, Rock rock) {
        super(rockTFCF, rock);
    ...
    public Item getItemDropped(IBlockState state, Random rand, int fortune) {
        return Item.getItemFromBlock(get(rock, Type.SANDY_LOAM));
    }
