...
public class BlockWaterPlantTFCF extends BlockWaterloggedPlant implements IItemSize, IPlantable, IFluidloggable
{
    ...
    {
        return TFCBlocks.isGround(state) || (state.getBlock() == BlockTallWaterPlantTFCF.get(plant));
    }
