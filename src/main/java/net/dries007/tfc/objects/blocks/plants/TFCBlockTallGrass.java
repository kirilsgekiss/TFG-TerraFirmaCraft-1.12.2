...
public class TFCBlockTallGrass extends TFCBlockShortGrass implements IGrowable, ITallPlant {
    private static final PropertyEnum<TFCBlockTallGrass.EnumBlockPart> PART = PropertyEnum.create("part", TFCBlockTallGrass.EnumBlockPart.class);
    private static final Map<Plant, TFCBlockTallGrass> MAP = new HashMap<>();

    public static TFCBlockTallGrass get(Plant plant) {
        return TFCBlockTallGrass.MAP.get(plant);
    }

    public TFCBlockTallGrass(Plant plant) {
        super(plant);
