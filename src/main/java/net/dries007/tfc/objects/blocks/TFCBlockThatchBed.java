...
public class TFCBlockThatchBed extends BlockBed {
    public TFCBlockThatchBed() {
    ...
    public void neighborChanged(IBlockState state, World worldIn, BlockPos pos, Block blockIn, BlockPos fromPos) {
        ...
        if (state.getValue(PART) == BlockBed.EnumPartType.FOOT) {
            if (!(worldIn.getBlockState(pos.offset(enumfacing)).getBlock() instanceof TFCBlockThatchBed)) {
                worldIn.setBlockToAir(pos);
            }
        } else if (!(worldIn.getBlockState(pos.offset(enumfacing)).getBlock() instanceof TFCBlockThatchBed)) {
            if (!worldIn.isRemote) {
