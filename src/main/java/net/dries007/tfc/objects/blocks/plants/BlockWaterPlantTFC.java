...
public class BlockWaterPlantTFC extends BlockPlantTFC implements IFluidloggable
{
    ...
    {
        return TFCBlocks.isGround(state) || (state.getBlock() == BlockTallWaterPlantTFC.get(plant));
    }
    ...
    public boolean canBlockStay(World worldIn, BlockPos pos, IBlockState state)
    {
        ...
        if (up.getBlock() instanceof BlockTallGrassWaterTFC) return false;
    ...
    {
        if (state.getBlock() instanceof BlockWaterPlantTFC)
    ...
    {
        return state.getBlock() instanceof BlockWaterPlantTFC && super.canCollideCheck(state, fullHit);
    }
