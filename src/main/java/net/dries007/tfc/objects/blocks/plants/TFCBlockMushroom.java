...
public class TFCBlockMushroom extends TFCBlockPlant implements IGrowable
{
    private static final Map<Plant, TFCBlockMushroom> MAP = new HashMap<>();

    public static TFCBlockMushroom get(Plant plant)
    {
        return MAP.get(plant);
    }

    public TFCBlockMushroom(Plant plant)
    {
        super(plant);
