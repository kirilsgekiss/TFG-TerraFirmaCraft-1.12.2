...
public class TFCBlockPowderKeg extends Block implements IItemSize, ILightableBlock {
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
        if (!worldIn.isRemote) {
            ...
            if (te != null) {
                ...
                } else if (state.getValue(SEALED) && TFCBlockTorch.canLight(heldItem)) {
                    if (!state.getValue(LIT)) {
    ...
    private boolean canStay(IBlockAccess world, BlockPos pos) {
        ...
        return solid || world.getBlockState(pos.down()).getBlock() instanceof TFCBlockPowderKeg;
    }
}
