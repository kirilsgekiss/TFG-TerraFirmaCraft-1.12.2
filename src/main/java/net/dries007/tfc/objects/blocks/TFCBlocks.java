...
//    public static final BlockBambooLeaves WEAVERS_BAMBOO_LEAVES = getNull();
    ...
    private static ImmutableList<TFCBlockFruitTreeLeaves> allFruitLeaves = getNull();
    private static ImmutableList<TFCBlockFruitTreeSapling> allFruitSapling = getNull();
    private static ImmutableList<TFCBlockCropDead> allDeadCrops = getNull();
    ...
    private static ImmutableList<TFCBlockSurfaceDriftwood> allSurfaceDriftwood = getNull();
    private static ImmutableList<TFCBlockSurfaceTwig> allSurfaceTwig = getNull();
    private static ImmutableList<TFCBlockSurfacePinecone> allSurfacePinecone = getNull();
    ...
    private static ImmutableList<TFCBlockSurfaceLightstone> allLightstoneBlocks = getNull();
...
//    private static ImmutableList<BlockJoshuaTreeSapling> allJoshuaTreeSaplingBlocks = getNull();
    ...
    public static ImmutableList<TFCBlockRockVariant> getAllBlockRockVariants() {
    ...
    public static ImmutableList<TFCBlockCropDead> getAllDeadCropBlocks() {
    ...
    public static ImmutableList<TFCBlockFruitTreeSapling> getAllFruitTreeSaplingBlocks() {
        return allFruitTreeSaplingBlocks;
    }

    public static ImmutableList<TFCBlockFruitTreeTrunk> getAllFruitTreeTrunkBlocks() {
        return allFruitTreeTrunkBlocks;
    }

    public static ImmutableList<TFCBlockFruitTreeBranch> getAllFruitTreeBranchBlocks() {
        return allFruitTreeBranchBlocks;
    }

    public static ImmutableList<TFCBlockFruitTreeLeaves> getAllFruitTreeLeavesBlocks() {
        return allFruitTreeLeavesBlocks;
    }

    public static ImmutableList<TFCBlockBerryBush> getAllBerryBushBlocks() {
    ...
    public static ImmutableList<TFCBlockFruitTreeLeaves> getAllFruitLeaves() {
        return allFruitLeaves;
    }

    public static ImmutableList<TFCBlockFruitTreeSapling> getAllFruitSapling() {
    ...
    public static ImmutableList<TFCBlockCropDead> getAllDeadCrops() {
        return allDeadCrops;
    }
    ...
    public static ImmutableList<TFCBlockSurfaceRock> getAllSurfaceRocks() {
        return allSurfaceRocks;
    }

    public static ImmutableList<TFCBlockSurfaceSeashells> getAllSurfaceSeashells() {
        return allSurfaceSeashells;
    }

    public static ImmutableList<TFCBlockSurfaceFlint> getAllSurfaceFlint() {
        return allSurfaceFlint;
    }

    public static ImmutableList<TFCBlockSurfaceBones> getAllSurfaceBones() {
        return allSurfaceBones;
    }

    public static ImmutableList<TFCBlockSurfaceDriftwood> getAllSurfaceDriftwood() {
        return allSurfaceDriftwood;
    }

    public static ImmutableList<TFCBlockSurfaceTwig> getAllSurfaceTwig() {
        return allSurfaceTwig;
    }

    public static ImmutableList<TFCBlockSurfacePinecone> getAllSurfacePinecone() {
    ...
    public static ImmutableList<TFCBlockCoral> getAllCoralPlants() {
    ...
    public static ImmutableList<TFCBlockPlantDummy1> getAllStandardBlocks() {
        return allStandardBlocks;
    }

    public static ImmutableList<TFCBlockSurfaceLightstone> getAllLightstoneBlocks() {
...
//    public static Tree[] bambooTrees = {DefaultTrees.ARROW_BAMBOO, DefaultTrees.BLACK_BAMBOO, DefaultTrees.BLUE_BAMBOO, DefaultTrees.DRAGON_BAMBOO, DefaultTrees.GOLDEN_BAMBOO, DefaultTrees.NARROW_LEAF_BAMBOO, DefaultTrees.RED_BAMBOO, DefaultTrees.TEMPLE_BAMBOO, DefaultTrees.THORNY_BAMBOO, DefaultTrees.TIMBER_BAMBOO, DefaultTrees.TINWA_BAMBOO, DefaultTrees.WEAVERS_BAMBOO};
    ...
    public static void registerBlocks(RegistryEvent.Register<Block> event) {
        ...
        ImmutableList.Builder<TFCBlockFruitTreeLeaves> fruitLeaves = ImmutableList.builder();
        ImmutableList.Builder<TFCBlockFruitTreeSapling> fruitSapling = ImmutableList.builder();
        ImmutableList.Builder<TFCBlockCrop> cropBlocks = ImmutableList.builder();
        ImmutableList.Builder<TFCBlockCropDead> deadCrops = ImmutableList.builder();
        ...
        ImmutableList.Builder<TFCBlockSurfaceDriftwood> surfaceDriftwood = ImmutableList.builder();
        ...
        ImmutableList.Builder<TFCBlockSurfaceLightstone> blockLightstone = ImmutableList.builder();
        ...
        normalItemBlocks.add(new TFCItemBlock(register(r, "thatch", new TFCBlockThatch(), CT_DECORATIONS)));
        normalItemBlocks.add(new TFCItemBlock(register(r, "fire_bricks", new TFCBlockFireBrick(), CT_DECORATIONS)));
        ...
        inventoryItemBlocks.add(new TFCItemBlock(register(r, "nest_box", new TFCBlockNestBox(), CT_MISC)));
        ...
        normalItemBlocks.add(new ItemBlockLargeVessel(register(r, "ceramics/fired/large_vessel", new TFCBlockLargeVessel(), CT_POTTERY)));
        normalItemBlocks.add(new ItemBlockPowderKeg(register(r, "powderkeg", new TFCBlockPowderKeg(), CT_WOOD)));

        normalItemBlocks.add(new TFCItemBlock(register(r, "alabaster/raw/plain", new TFCBlockRockDecorative(MapColor.SNOW), CT_DECORATIONS)));
        normalItemBlocks.add(new TFCItemBlock(register(r, "alabaster/polished/plain", new TFCBlockRockDecorative(MapColor.SNOW), CT_DECORATIONS)));
        normalItemBlocks.add(new TFCItemBlock(register(r, "alabaster/bricks/plain", new TFCBlockRockDecorative(MapColor.SNOW), CT_DECORATIONS)));
        ...
        normalItemBlocks.add(new TFCItemBlock(register(r, "ceramics/earthenware/earthenware_bricks", new TFCBlockFireBrick(), CT_DECORATIONS)));
        normalItemBlocks.add(new ItemBlockLargeVessel(register(r, "ceramics/earthenware/fired/large_vessel", new TFCBlockLargeVessel(), CT_POTTERY)));
        ...
        normalItemBlocks.add(new TFCItemBlock(register(r, "ceramics/kaolinite/kaolinite_bricks", new TFCBlockFireBrick(), CT_DECORATIONS)));
        normalItemBlocks.add(new ItemBlockLargeVessel(register(r, "ceramics/kaolinite/fired/large_vessel", new TFCBlockLargeVessel(), CT_POTTERY)));
        ...
        normalItemBlocks.add(new TFCItemBlock(register(r, "ceramics/stoneware/stoneware_bricks", new TFCBlockFireBrick(), CT_DECORATIONS)));
        normalItemBlocks.add(new ItemBlockLargeVessel(register(r, "ceramics/stoneware/fired/large_vessel", new TFCBlockLargeVessel(), CT_POTTERY)));
        ...
        {
            Builder<TFCBlockRockVariant> b = ImmutableList.builder();
            for (Type type : values()) {
                for (Rock rock : TFCRegistries.ROCKS.getValuesCollection()) {
                    if (type != ANVIL) {
                        b.add(register(r, type.name().toLowerCase() + "/" + rock.getRegistryName().getPath(), TFCBlockRockVariant.create(rock, type), CT_ROCK_BLOCKS));
...

        {
            ...
            for (Type type : new Type[]{SMOOTH, COBBLE, BRICKS, MUD_BRICKS})
                for (Rock rock : TFCRegistries.ROCKS.getValuesCollection())
                    blockWallTFC.add(register(r, ("wall/" + type.name().toLowerCase() + "/" + rock.getRegistryName().getPath()).toLowerCase(), new TFCBlockRockWall(TFCBlockRockVariant.get(rock, type)), CT_DECORATIONS));
        ...
        {
            Builder<TFCBlockFruitTreeSapling> fSaplings = ImmutableList.builder();
            Builder<TFCBlockFruitTreeTrunk> fTrunks = ImmutableList.builder();
            Builder<TFCBlockFruitTreeBranch> fBranches = ImmutableList.builder();
            Builder<TFCBlockFruitTreeLeaves> fLeaves = ImmutableList.builder();

            for (FruitTree tree : FruitTree.values()) {
                fSaplings.add(register(r, "fruit_trees/sapling/" + tree.name().toLowerCase(), new TFCBlockFruitTreeSapling(tree), CT_WOOD));
                fTrunks.add(register(r, "fruit_trees/trunk/" + tree.name().toLowerCase(), new TFCBlockFruitTreeTrunk(tree)));
                fBranches.add(register(r, "fruit_trees/branch/" + tree.name().toLowerCase(), new TFCBlockFruitTreeBranch(tree)));
                fLeaves.add(register(r, "fruit_trees/leaves/" + tree.name().toLowerCase(), new TFCBlockFruitTreeLeaves(tree), CT_WOOD));
            }
            ...
            Builder<TFCBlockBerryBush> fBerry = ImmutableList.builder();
            {
                for (BerryBush bush : BerryBush.values()) {
                    fBerry.add(register(r, "berry_bush/" + bush.name().toLowerCase(), new TFCBlockBerryBush(bush), CT_FOOD));
                }
...

        {
            ...
            Builder<TFCBlockFlowerPot> plantInPotBlock = ImmutableList.builder();
...
/*
        ...
        // Normal Corals
        plantCoral.add(register(r, "coral/tube/dead", new TFCBlockCoral(TFCFluids.SEA_WATER.get(), MapColor.SNOW), CT_FLORA));
        plantCoral.add(register(r, "coral/brain/dead", new TFCBlockCoral(TFCFluids.SEA_WATER.get(), MapColor.SNOW), CT_FLORA));
        plantCoral.add(register(r, "coral/bubble/dead", new TFCBlockCoral(TFCFluids.SEA_WATER.get(), MapColor.SNOW), CT_FLORA));
        plantCoral.add(register(r, "coral/fire/dead", new TFCBlockCoral(TFCFluids.SEA_WATER.get(), MapColor.SNOW), CT_FLORA));
        plantCoral.add(register(r, "coral/horn/dead", new TFCBlockCoral(TFCFluids.SEA_WATER.get(), MapColor.SNOW), CT_FLORA));
        ...
        // Fan Corals
        plantCoral.add(register(r, "coral/fan/tube/dead", new TFCBlockCoral(TFCFluids.SEA_WATER.get(), MapColor.SNOW), CT_FLORA));
        plantCoral.add(register(r, "coral/fan/brain/dead", new TFCBlockCoral(TFCFluids.SEA_WATER.get(), MapColor.SNOW), CT_FLORA));
        plantCoral.add(register(r, "coral/fan/bubble/dead", new TFCBlockCoral(TFCFluids.SEA_WATER.get(), MapColor.SNOW), CT_FLORA));
        plantCoral.add(register(r, "coral/fan/fire/dead", new TFCBlockCoral(TFCFluids.SEA_WATER.get(), MapColor.SNOW), CT_FLORA));
        plantCoral.add(register(r, "coral/fan/horn/dead", new TFCBlockCoral(TFCFluids.SEA_WATER.get(), MapColor.SNOW), CT_FLORA));
        ...
        for (TFCBlockSurfaceLightstone lightstone : allLightstoneBlocks) {
