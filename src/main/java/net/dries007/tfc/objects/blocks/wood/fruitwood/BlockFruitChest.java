...
public class BlockFruitChest extends BlockChest implements IItemSize
{
    ...
    private static final Map<IFruitTree, BlockFruitChest> MAP_BASIC = new HashMap<>();
    private static final Map<IFruitTree, BlockFruitChest> MAP_TRAP = new HashMap<>();

    private static final Map<Tree, BlockFruitChest> MAP_BASIC_TREE = new HashMap<>();
    private static final Map<Tree, BlockFruitChest> MAP_TRAP_TREE = new HashMap<>();

    public static BlockFruitChest getBasic(IFruitTree tree)
    {
        return MAP_BASIC.get(tree);
    }

    public static BlockFruitChest getTrap(IFruitTree tree)
    {
        return MAP_TRAP.get(tree);
    }

    public static BlockFruitChest getBasicTree(Tree tree)
    {
        return MAP_BASIC_TREE.get(tree);
    }

    public static BlockFruitChest getTrapTree(Tree tree)
    {
    ...
    public BlockFruitChest(Type type, IFruitTree tree)
    {
        super(type);
        this.wood = tree;
        this.tree = null;
    ...
    public BlockFruitChest(Type type, Tree tree)
    {
        super(type);
        this.tree = tree;
        this.wood = null;
