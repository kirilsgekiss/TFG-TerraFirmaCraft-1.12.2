...
public class TFCBlockFarmlandHumus extends TFCBlockFarmland {
    ...
    public TFCBlockFarmlandHumus(Type rockTFCF, Rock rock) {
        super(rockTFCF, rock);
    ...
    public Item getItemDropped(IBlockState state, Random rand, int fortune) {
        return Item.getItemFromBlock(get(rock, Type.HUMUS));
    }
