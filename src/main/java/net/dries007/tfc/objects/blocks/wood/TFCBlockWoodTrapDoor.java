...
public class TFCBlockWoodTrapDoor extends BlockTrapDoor implements IHasModel, IWoodHandler {
    private final ResourceLocation MODEL_LOCATION = new ResourceLocation(MOD_ID, "wood/trapdoor");
