...
public class TFCBlockCharcoalPile extends Block implements ILightableBlock {
    ...
    public void neighborChanged(IBlockState state, World worldIn, BlockPos pos, Block blockIn, BlockPos fromPos) {
        if (!worldIn.isRemote) {
            ...
            if (stateUnder.getBlock() instanceof TFCBlockCharcoalPile) {
