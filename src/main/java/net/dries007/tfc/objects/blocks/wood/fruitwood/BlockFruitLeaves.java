...
public class BlockFruitLeaves extends BlockLeaves implements IGrowingPlant
{
    public static final PropertyEnum<EnumLeafState> LEAF_STATE = PropertyEnum.create("state", BlockFruitLeaves.EnumLeafState.class);
    public static final PropertyBool HARVESTABLE = PropertyBool.create("harvestable");
    private static final Map<SeasonalTrees, BlockFruitLeaves> MAP = new HashMap<>();

    public static BlockFruitLeaves get(SeasonalTrees wood)
    {
        return MAP.get(wood);
    }
    ...
    public BlockFruitLeaves(Tree wood, SeasonalTrees tree)
    {
        this.wood = wood;
        this.fruitTree = tree;
