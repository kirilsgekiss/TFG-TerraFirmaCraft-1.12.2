...
public class TFCBlockCactus extends TFCBlockPlant implements IGrowable, ITallPlant {
    private static final PropertyEnum<EnumBlockPart> PART = PropertyEnum.create("part", EnumBlockPart.class);
    private static final Map<Plant, TFCBlockCactus> MAP = new HashMap<>();

    public static TFCBlockCactus get(Plant plant) {
        return MAP.get(plant);
    }

    public TFCBlockCactus(Plant plant) {
        super(plant);
    ...
    public boolean canBlockStay(World worldIn, BlockPos pos, IBlockState state) {
        ...
        if (state.getBlock() == this) {
            ...
            return flag &&
                    ...
                    plant.isValidTemp(TFCClimate.getActualTemp(worldIn, pos)) &&
