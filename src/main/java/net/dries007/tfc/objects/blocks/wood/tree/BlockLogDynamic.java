...
public class BlockLogDynamic extends BlockLog
{
    private static final Map<Tree, BlockLogDynamic> MAP = new HashMap<>();
    public final Tree tree;

    public static BlockLogDynamic get(Tree tree)
    {
        return MAP.get(tree);
    }

    public BlockLogDynamic(Tree tree)
    {
        super();
