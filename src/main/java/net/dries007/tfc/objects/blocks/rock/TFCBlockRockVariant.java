...
import net.dries007.tfc.objects.blocks.rock.path.*;
    ...
    public static TFCBlockRockVariant create(Rock rock, Type type) {
        switch (type) {
            ...
            case LOAMY_SAND_FARMLAND:
                return new TFCBlockFarmlandLoamySand(type, rock);
            case SANDY_LOAM_FARMLAND:
                return new TFCBlockFarmlandSandyLoam(type, rock);
            case LOAM_FARMLAND:
                return new TFCBlockFarmlandLoam(type, rock);
            case SILT_LOAM_FARMLAND:
                return new TFCBlockFarmlandSiltLoam(type, rock);
            case SILT_FARMLAND:
                return new TFCBlockFarmlandSilt(type, rock);
            case HUMUS_FARMLAND:
                return new TFCBlockFarmlandHumus(type, rock);
            case PATH:
                return new TFCBlockPath(type, rock);
            case LOAMY_SAND_PATH:
                return new TFCBlockPathLoamySand(type, rock);
            case SANDY_LOAM_PATH:
                return new TFCBlockPathSandyLoam(type, rock);
            case LOAM_PATH:
                return new TFCBlockPathLoam(type, rock);
            case SILT_LOAM_PATH:
                return new TFCBlockPathSiltLoam(type, rock);
            case SILT_PATH:
                return new TFCBlockPathSilt(type, rock);
            case HUMUS_PATH:
                return new TFCBlockPathHumus(type, rock);
            case GRASS:
            case DRY_GRASS:
            case CLAY_GRASS:
            case PODZOL:
                ...
                switch (side) {
                    ...
                    case EAST:
                        ...
                        if (block instanceof BlockFarmland ||
                                ...
                                block instanceof TFCBlockFarmlandLoamySand ||
                                block instanceof TFCBlockFarmlandSandyLoam ||
                                block instanceof TFCBlockFarmlandLoam ||
                                block instanceof TFCBlockFarmlandSiltLoam ||
                                block instanceof TFCBlockFarmlandSilt ||
                                block instanceof TFCBlockFarmlandHumus /*
                         * ||
