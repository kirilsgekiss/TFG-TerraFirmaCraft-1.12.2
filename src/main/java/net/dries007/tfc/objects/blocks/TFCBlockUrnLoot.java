...
public class TFCBlockUrnLoot extends Block implements IItemSize // TODO ALL
{
    ...
    private static ImmutableList<Material> metalList = null;

    public TFCBlockUrnLoot() {
    ...
    private static gregtech.api.unification.material.Material getRandomMetal(Random rand) {
        /*
        if (metalList == null)
        {
    ...
    public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
        ...
        if (chance == 0) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                drops.add(new ItemStack(dropList[dropIndex], amount, this.damageDropped(state)));*/ // todo
            }
        }
    }
