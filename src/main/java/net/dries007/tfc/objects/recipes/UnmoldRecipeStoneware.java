...
public class UnmoldRecipeStoneware extends IForgeRegistryEntry.Impl<IRecipe> implements IRecipe
{
    ...
    private UnmoldRecipeStoneware(@Nullable ResourceLocation group, NonNullList<Ingredient> input, @Nonnull OrePrefix type, float chance)
    {
        this.group = group;
        this.input = input;
        this.type = type;
    ...
    public static class Factory implements IRecipeFactory
    {
        ...
        public IRecipe parse(final JsonContext context, final JsonObject json)
        {
            ...
            return new UnmoldRecipeStoneware
                    (
