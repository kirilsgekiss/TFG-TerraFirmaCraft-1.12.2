...
public final class TFCRegistryNames {
    ...
    public static final ResourceLocation WOOD = new ResourceLocation(MOD_ID, "wood");
    ...
    public static final ResourceLocation ALEMBIC_RECIPE = new ResourceLocation(MOD_ID, "alembic_recipe");
    public static final ResourceLocation DRYING_RECIPE = new ResourceLocation(MOD_ID, "drying_recipe");
    public static final ResourceLocation STICK_BUNDLE_RECIPE = new ResourceLocation(MOD_ID, "stick_bundle_recipe");
}
