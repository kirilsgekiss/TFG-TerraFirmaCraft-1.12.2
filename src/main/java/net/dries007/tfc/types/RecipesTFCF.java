...
//                new PlanterRecipe(IIngredient.of(ItemSeedsTFC.get(CropTFCF.SISAL)), new ItemStack(ItemsTFC.SISAL), 6, false).setRegistryName("sisal"),
...
//                new PlanterRecipe(IIngredient.of(ItemSeedsTFC.get(CropTFCF.LINEN)), new ItemStack(ItemsTFC.LINEN), 6, true).setRegistryName("linen"),
