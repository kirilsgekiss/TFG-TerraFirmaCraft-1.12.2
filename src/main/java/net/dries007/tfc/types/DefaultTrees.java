...
public final class DefaultTrees
{
    ...
    public static final ITreeGenerator GEN_NORMAL = new TreeGenDynamic();
    public static final ITreeGenerator GEN_MEDIUM = new TreeGenDynamic();
    public static final ITreeGenerator GEN_TALL = new TreeGenDynamic();
    public static final ITreeGenerator GEN_CONIFER = new TreeGenDynamic();
    public static final ITreeGenerator GEN_TROPICAL = new TreeGenDynamic();
    public static final ITreeGenerator GEN_WILLOW = new TreeGenDynamic();
    public static final ITreeGenerator GEN_ACACIA = new TreeGenDynamic();
    public static final ITreeGenerator GEN_KAPOK = new TreeGenDynamic();
    public static final ITreeGenerator GEN_SEQUOIA = new TreeGenDynamic();
    public static final ITreeGenerator GEN_KAPOK_COMPOSITE = new TreeGenDynamic();
    public static final ITreeGenerator GEN_BUSHES = new TreeGenDynamic();
    public static final ITreeGenerator GEN_ASPEN = new TreeGenDynamic();
    public static final ITreeGenerator GEN_AFRICAN_PADAUK = new TreeGenDynamic();
    public static final ITreeGenerator GEN_ALDER = new TreeGenDynamic();
    public static final ITreeGenerator GEN_ANGELIM = new TreeGenDynamic();
    public static final ITreeGenerator GEN_BALD_CYPRESS = new TreeGenDynamic();
    public static final ITreeGenerator GEN_BAOBAB = new TreeGenDynamic();
    public static final ITreeGenerator GEN_BEECH = new TreeGenDynamic();
    public static final ITreeGenerator GEN_BLACK_WALNUT = new TreeGenDynamic();
    //public static final ITreeGenerator GEN_BOX = new TreeGenVariants(true, 9);			// Tall Tree Model
    public static final ITreeGenerator GEN_BRAZILWOOD = new TreeGenDynamic();
    public static final ITreeGenerator GEN_BUTTERNUT = new TreeGenDynamic();
    public static final ITreeGenerator GEN_COCOBOLO = new TreeGenDynamic();
    public static final ITreeGenerator GEN_CYPRESS = new TreeGenDynamic();
    public static final ITreeGenerator GEN_EBONY = new TreeGenDynamic();
    public static final ITreeGenerator GEN_EUCALYPTUS = new TreeGenDynamic();
    public static final ITreeGenerator GEN_EUROPEAN_OAK = new TreeGenDynamic();
    public static final ITreeGenerator GEN_FEVER = new TreeGenDynamic();
    public static final ITreeGenerator GEN_FRUITWOOD = new TreeGenDynamic();
    //public static final ITreeGenerator GEN_GIGANTEUM = new TreeGenVariants(true, 10);		// Redwood
    public static final ITreeGenerator GEN_GINKGO = new TreeGenDynamic();
    public static final ITreeGenerator GEN_GREENHEART = new TreeGenDynamic();
    public static final ITreeGenerator GEN_HAWTHORN = new TreeGenDynamic();
    public static final ITreeGenerator GEN_HAZEL = new TreeGenDynamic();
    public static final ITreeGenerator GEN_HEMLOCK = new TreeGenDynamic();
    public static final ITreeGenerator GEN_HOLLY = new TreeGenDynamic();
    public static final ITreeGenerator GEN_HORNBEAM = new TreeGenDynamic();
    public static final ITreeGenerator GEN_IPE = new TreeGenDynamic();
    public static final ITreeGenerator GEN_IROKO = new TreeGenDynamic();
    public static final ITreeGenerator GEN_IRONWOOD = new TreeGenDynamic();
    public static final ITreeGenerator GEN_JACARANDA = new TreeGenDynamic();
    public static final ITreeGenerator GEN_JOSHUA_TREE = new TreeGenDynamic();
    public static final ITreeGenerator GEN_JUNIPER = new TreeGenDynamic();
    public static final ITreeGenerator GEN_KAURI = new TreeGenDynamic();
    public static final ITreeGenerator GEN_LARCH = new TreeGenDynamic();
    public static final ITreeGenerator GEN_LIMBA = new TreeGenDynamic();
    public static final ITreeGenerator GEN_LOCUST = new TreeGenDynamic();
    public static final ITreeGenerator GEN_LOGWOOD = new TreeGenDynamic();
    public static final ITreeGenerator GEN_MACLURA = new TreeGenDynamic();
    public static final ITreeGenerator GEN_MAHOE = new TreeGenDynamic();
    public static final ITreeGenerator GEN_MAHOGANY = new TreeGenDynamic();
    public static final ITreeGenerator GEN_MANGROVE = new TreeGenDynamic();
    public static final ITreeGenerator GEN_MARBLEWOOD = new TreeGenDynamic();
    public static final ITreeGenerator GEN_MESSMATE = new TreeGenDynamic();
    public static final ITreeGenerator GEN_MOUNTAIN_ASH = new TreeGenDynamic();
    public static final ITreeGenerator GEN_MULBERRY = new TreeGenDynamic();
    public static final ITreeGenerator GEN_NORDMANN_FIR = new TreeGenDynamic();
    public static final ITreeGenerator GEN_NORWAY_SPRUCE = new TreeGenDynamic();
    public static final ITreeGenerator GEN_PINK_CHERRY = new TreeGenDynamic();
    public static final ITreeGenerator GEN_PINK_IVORY = new TreeGenDynamic();
    public static final ITreeGenerator GEN_POPLAR = new TreeGenDynamic();
    public static final ITreeGenerator GEN_PURPLEHEART = new TreeGenDynamic();
    public static final ITreeGenerator GEN_RED_CEDAR = new TreeGenDynamic();
    public static final ITreeGenerator GEN_RED_ELM = new TreeGenDynamic();
    public static final ITreeGenerator GEN_REDWOOD = new TreeGenDynamic();
    public static final ITreeGenerator GEN_ROWAN = new TreeGenDynamic();
    public static final ITreeGenerator GEN_RUBBER_FIG = new TreeGenDynamic();
    public static final ITreeGenerator GEN_SWEETGUM = new TreeGenDynamic();
    public static final ITreeGenerator GEN_SYZYGIUM = new TreeGenDynamic();
    public static final ITreeGenerator GEN_TEAK = new TreeGenDynamic();
    public static final ITreeGenerator GEN_WALNUT = new TreeGenDynamic();
    public static final ITreeGenerator GEN_WENGE = new TreeGenDynamic();
    public static final ITreeGenerator GEN_WHITE_CHERRY = new TreeGenDynamic();
    public static final ITreeGenerator GEN_WHITE_ELM = new TreeGenDynamic();
    public static final ITreeGenerator GEN_WHITEBEAM = new TreeGenDynamic();
    public static final ITreeGenerator GEN_YELLOW_MERANTI = new TreeGenDynamic();
    public static final ITreeGenerator GEN_YEW = new TreeGenDynamic();
    public static final ITreeGenerator GEN_ZEBRAWOOD = new TreeGenDynamic();

    public static final ITreeGenerator GEN_TALL_TFC = new TreeGenDynamic();

    public static final ITreeGenerator GEN_TALL_SINGLE = new TreeGenDynamic();

    public static final ITreeGenerator GEN_CASSIA_CINNAMON = new TreeGenDynamic();
    public static final ITreeGenerator GEN_CEYLON_CINNAMON = new TreeGenDynamic();

    public static final ITreeGenerator GEN_ARROW_BAMBOO = new TreeGenDynamic();	// Pseudosasa japonica
    public static final ITreeGenerator GEN_BLACK_BAMBOO = new TreeGenDynamic(); // Phyllostachys nigra
    public static final ITreeGenerator GEN_BLUE_BAMBOO = new TreeGenDynamic(); // Himalayacalamus hookerianus
    public static final ITreeGenerator GEN_DRAGON_BAMBOO = new TreeGenDynamic(); // Dendrocalamus giganteus
    public static final ITreeGenerator GEN_GOLDEN_BAMBOO = new TreeGenDynamic(); // Alphonse Karr
    public static final ITreeGenerator GEN_NARROW_LEAF_BAMBOO = new TreeGenDynamic(); // Guadua angustifolia
    public static final ITreeGenerator GEN_RED_BAMBOO = new TreeGenDynamic(); // Fargesia nitida Jiuzhaigou
    public static final ITreeGenerator GEN_TEMPLE_BAMBOO = new TreeGenDynamic(); // Semiarundinaria fastuosa
    public static final ITreeGenerator GEN_THORNY_BAMBOO = new TreeGenDynamic(); // Chimonobambusa pachystachys
    public static final ITreeGenerator GEN_TIMBER_BAMBOO = new TreeGenDynamic(); // Phyllostachys vivax
    public static final ITreeGenerator GEN_TINWA_BAMBOO = new TreeGenDynamic(); // Cephalostachyum pergracile
    public static final ITreeGenerator GEN_WEAVERS_BAMBOO = new TreeGenDynamic(); // Bambusa textilis
