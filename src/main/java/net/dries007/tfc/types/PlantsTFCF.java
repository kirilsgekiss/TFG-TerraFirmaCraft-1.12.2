...
{
    public static final ResourceLocation CATTAIL = new ResourceLocation(TFCFLORAE_MODID, "cattail");
    public static final ResourceLocation CHAMOMILE = new ResourceLocation(TFCFLORAE_MODID, "chamomile");
    public static final ResourceLocation DEVILS_TONGUE = new ResourceLocation(TFCFLORAE_MODID, "devils_tongue");
    public static final ResourceLocation HYDRANGEA = new ResourceLocation(TFCFLORAE_MODID, "hydrangea");
    public static final ResourceLocation LAVANDULA = new ResourceLocation(TFCFLORAE_MODID, "lavandula");
    public static final ResourceLocation LEAF_LITTER = new ResourceLocation(TFCFLORAE_MODID, "leaf_litter");
    public static final ResourceLocation LILAC = new ResourceLocation(TFCFLORAE_MODID, "lilac");
    public static final ResourceLocation LILY_OF_THE_VALLEY = new ResourceLocation(TFCFLORAE_MODID, "lily_of_the_valley");
    public static final ResourceLocation MADDER = new ResourceLocation(TFCFLORAE_MODID, "madder");
    public static final ResourceLocation OCOTILLO = new ResourceLocation(TFCFLORAE_MODID, "ocotillo");
    public static final ResourceLocation PAPYRUS = new ResourceLocation(TFCFLORAE_MODID, "papyrus");
    public static final ResourceLocation PEONY = new ResourceLocation(TFCFLORAE_MODID, "peony");
    public static final ResourceLocation SHRUB = new ResourceLocation(TFCFLORAE_MODID, "shrub");
    public static final ResourceLocation CHAPARRAL_SHRUB = new ResourceLocation(TFCFLORAE_MODID, "chaparral_shrub");
    public static final ResourceLocation SUGAR_CANE = new ResourceLocation(TFCFLORAE_MODID, "sugar_cane");
    public static final ResourceLocation SUNFLOWER = new ResourceLocation(TFCFLORAE_MODID, "sunflower");
    public static final ResourceLocation TACKWEED = new ResourceLocation(TFCFLORAE_MODID, "tackweed");
    public static final ResourceLocation TAKAKIA = new ResourceLocation(TFCFLORAE_MODID, "takakia");
    public static final ResourceLocation LOW_UNDERGROWTH = new ResourceLocation(TFCFLORAE_MODID, "undergrowth_low");
    public static final ResourceLocation TROPICAL_UNDERGROWTH = new ResourceLocation(TFCFLORAE_MODID, "undergrowth_tropical");
    public static final ResourceLocation VOODOO_LILY = new ResourceLocation(TFCFLORAE_MODID, "voodoo_lily");
    public static final ResourceLocation BROMELIA_HEMISPHERICA = new ResourceLocation(TFCFLORAE_MODID, "bromelia_hemispherica");
    public static final ResourceLocation BROMELIA_LACINIOSA = new ResourceLocation(TFCFLORAE_MODID, "bromelia_laciniosa");
    public static final ResourceLocation KAIETEUR_FALLS = new ResourceLocation(TFCFLORAE_MODID, "kaieteur_falls");
    public static final ResourceLocation MATTEUCCIA = new ResourceLocation(TFCFLORAE_MODID, "matteuccia");
    public static final ResourceLocation CORD_GRASS = new ResourceLocation(TFCFLORAE_MODID, "cord_grass");
    public static final ResourceLocation REED_MANNAGRASS = new ResourceLocation(TFCFLORAE_MODID, "reed_mannagrass");
    public static final ResourceLocation PRAIRIE_JUNEGRASS = new ResourceLocation(TFCFLORAE_MODID, "prairie_junegrass");
    public static final ResourceLocation WOOLLY_BUSH = new ResourceLocation(TFCFLORAE_MODID, "woolly_bush");
    public static final ResourceLocation CINNAMON_FERN = new ResourceLocation(TFCFLORAE_MODID, "cinnamon_fern");
    public static final ResourceLocation JAPANESE_PIERIS = new ResourceLocation(TFCFLORAE_MODID, "japanese_pieris");
    public static final ResourceLocation BURNING_BUSH = new ResourceLocation(TFCFLORAE_MODID, "burning_bush");
    public static final ResourceLocation UNDERGROWTH_SHRUB = new ResourceLocation(TFCFLORAE_MODID, "undergrowth_shrub");
    public static final ResourceLocation UNDERGROWTH_SHRUB_SMALL = new ResourceLocation(TFCFLORAE_MODID, "undergrowth_shrub_small");
    public static final ResourceLocation SEA_OATS = new ResourceLocation(TFCFLORAE_MODID, "sea_oats");
    public static final ResourceLocation BUNCH_GRASS_FLOATING = new ResourceLocation(TFCFLORAE_MODID, "bunch_grass_floating");
    public static final ResourceLocation BUNCH_GRASS_REED = new ResourceLocation(TFCFLORAE_MODID, "bunch_grass_reed");
    public static final ResourceLocation CROWNGRASS = new ResourceLocation(TFCFLORAE_MODID, "crowngrass");
    public static final ResourceLocation CAT_GRASS = new ResourceLocation(TFCFLORAE_MODID, "cat_grass");
    public static final ResourceLocation GOOSEGRASS = new ResourceLocation(TFCFLORAE_MODID, "goosegrass");
    public static final ResourceLocation WHEATGRASS = new ResourceLocation(TFCFLORAE_MODID, "wheatgrass");
    public static final ResourceLocation HALFA_GRASS = new ResourceLocation(TFCFLORAE_MODID, "halfa_grass");
    public static final ResourceLocation LEYMUS = new ResourceLocation(TFCFLORAE_MODID, "leymus");
    public static final ResourceLocation MARRAM_GRASS = new ResourceLocation(TFCFLORAE_MODID, "marram_grass");
    ...
    public static final ResourceLocation SAWGRASS = new ResourceLocation(TFCFLORAE_MODID, "sawgrass");
    public static final ResourceLocation SAGUARO_CACTUS = new ResourceLocation(TFCFLORAE_MODID, "saguaro_cactus");

    public static final ResourceLocation CAVE_VINES = new ResourceLocation(TFCFLORAE_MODID, "cave_vines");
    public static final ResourceLocation GLOW_VINES = new ResourceLocation(TFCFLORAE_MODID, "glow_vines");
    public static final ResourceLocation ROOTS = new ResourceLocation(TFCFLORAE_MODID, "roots");
    public static final ResourceLocation ICICLE = new ResourceLocation(TFCFLORAE_MODID, "icicle");
    public static final ResourceLocation RESIN = new ResourceLocation(TFCFLORAE_MODID, "resin");

    // Vine/Ivy
    public static final ResourceLocation RATTAN = new ResourceLocation(TFCFLORAE_MODID, "rattan");
    public static final ResourceLocation BEARDED_MOSS = new ResourceLocation(TFCFLORAE_MODID, "bearded_moss");
    public static final ResourceLocation BLUE_SKYFLOWER = new ResourceLocation(TFCFLORAE_MODID, "blue_skyflower");
    public static final ResourceLocation GLOW_VINE = new ResourceLocation(TFCFLORAE_MODID, "glow_vine");
    public static final ResourceLocation HANGING_VINE = new ResourceLocation(TFCFLORAE_MODID, "hanging_vine");
    public static final ResourceLocation IVY = new ResourceLocation(TFCFLORAE_MODID, "ivy");
    public static final ResourceLocation JADE_VINE = new ResourceLocation(TFCFLORAE_MODID, "jade_vine");
    public static final ResourceLocation JAPANESE_IVY = new ResourceLocation(TFCFLORAE_MODID, "japanese_ivy");
    public static final ResourceLocation JUNGLE_VINE = new ResourceLocation(TFCFLORAE_MODID, "jungle_vine");
    public static final ResourceLocation LIANA = new ResourceLocation(TFCFLORAE_MODID, "liana");
    public static final ResourceLocation MADEIRA_VINE = new ResourceLocation(TFCFLORAE_MODID, "madeira_vine");
    public static final ResourceLocation MYSORE_TRUMPETVINE = new ResourceLocation(TFCFLORAE_MODID, "mysore_trumpetvine");
    public static final ResourceLocation SILVERVEIN_CREEPER = new ResourceLocation(TFCFLORAE_MODID, "silvervein_creeper");
    public static final ResourceLocation SWEDISH_IVY = new ResourceLocation(TFCFLORAE_MODID, "swedish_ivy");
    public static final ResourceLocation VARIEGATED_PERSIAN_IVY = new ResourceLocation(TFCFLORAE_MODID, "variegated_persian_ivy");

    // Epiphytes
    public static final ResourceLocation APACHE_DWARF = new ResourceLocation(TFCFLORAE_MODID, "apache_dwarf");
    public static final ResourceLocation ARTISTS_CONK = new ResourceLocation(TFCFLORAE_MODID, "artists_conk");
    public static final ResourceLocation CLIMBING_CACTUS = new ResourceLocation(TFCFLORAE_MODID, "climbing_cactus");
    public static final ResourceLocation CRIMSON_CATTLEYA = new ResourceLocation(TFCFLORAE_MODID, "crimson_cattleya");
    public static final ResourceLocation CREEPING_MISTLETOE = new ResourceLocation(TFCFLORAE_MODID, "creeping_mistletoe");
    public static final ResourceLocation CUTHBERTS_DENDROBIUM = new ResourceLocation(TFCFLORAE_MODID, "cuthberts_dendrobium");
    public static final ResourceLocation FISH_BONE_CACTUS = new ResourceLocation(TFCFLORAE_MODID, "fish_bone_cactus");
    public static final ResourceLocation FRAGRANT_FERN = new ResourceLocation(TFCFLORAE_MODID, "fragrant_fern");
    public static final ResourceLocation HARLEQUIN_MISTLETOE = new ResourceLocation(TFCFLORAE_MODID, "harlequin_mistletoe");
    public static final ResourceLocation KING_ORCHID = new ResourceLocation(TFCFLORAE_MODID, "king_orchid");
    public static final ResourceLocation LANTERN_OF_THE_FOREST = new ResourceLocation(TFCFLORAE_MODID, "lantern_of_the_forest");
    public static final ResourceLocation LARGE_FOOT_DENDROBIUM = new ResourceLocation(TFCFLORAE_MODID, "large_foot_dendrobium");
    public static final ResourceLocation COMMON_MISTLETOE = new ResourceLocation(TFCFLORAE_MODID, "common_mistletoe");
    public static final ResourceLocation SKY_PLANT = new ResourceLocation(TFCFLORAE_MODID, "sky_plant");
    public static final ResourceLocation SULPHUR_SHELF = new ResourceLocation(TFCFLORAE_MODID, "sulphur_shelf");
    public static final ResourceLocation TAMPA_BUTTERFLY_ORCHID = new ResourceLocation(TFCFLORAE_MODID, "tampa_butterfly_orchid");
    public static final ResourceLocation TURKEY_TAIL = new ResourceLocation(TFCFLORAE_MODID, "turkey_tail");
    public static final ResourceLocation WILDFIRE = new ResourceLocation(TFCFLORAE_MODID, "wildfire");

    // Water Plants
    public static final ResourceLocation BADDERLOCKS = new ResourceLocation(TFCFLORAE_MODID, "badderlocks");
    public static final ResourceLocation BROWN_ALGAE = new ResourceLocation(TFCFLORAE_MODID, "brown_algae");
    public static final ResourceLocation COONTAIL = new ResourceLocation(TFCFLORAE_MODID, "coontail");
    public static final ResourceLocation EEL_GRASS = new ResourceLocation(TFCFLORAE_MODID, "eel_grass");
    public static final ResourceLocation GIANT_KELP = new ResourceLocation(TFCFLORAE_MODID, "giant_kelp");
    public static final ResourceLocation GUTWEED = new ResourceLocation(TFCFLORAE_MODID, "gutweed");
    public static final ResourceLocation HORNWORT = new ResourceLocation(TFCFLORAE_MODID, "hornwort");
    public static final ResourceLocation LAMINARIA = new ResourceLocation(TFCFLORAE_MODID, "laminaria");
    public static final ResourceLocation LEAFY_KELP = new ResourceLocation(TFCFLORAE_MODID, "leafy_kelp");
    public static final ResourceLocation MANATEE_GRASS = new ResourceLocation(TFCFLORAE_MODID, "manatee_grass");
    public static final ResourceLocation MILFOIL = new ResourceLocation(TFCFLORAE_MODID, "milfoil");
    public static final ResourceLocation PONDWEED = new ResourceLocation(TFCFLORAE_MODID, "pondweed");
    public static final ResourceLocation SAGO = new ResourceLocation(TFCFLORAE_MODID, "sago");
    public static final ResourceLocation SEAGRASS = new ResourceLocation(TFCFLORAE_MODID, "seagrass");
    public static final ResourceLocation SEAWEED = new ResourceLocation(TFCFLORAE_MODID, "seaweed");
    public static final ResourceLocation STAR_GRASS = new ResourceLocation(TFCFLORAE_MODID, "star_grass");
    public static final ResourceLocation TURTLE_GRASS = new ResourceLocation(TFCFLORAE_MODID, "turtle_grass");
    public static final ResourceLocation WINGED_KELP = new ResourceLocation(TFCFLORAE_MODID, "winged_kelp");
    public static final ResourceLocation RED_ALGAE = new ResourceLocation(TFCFLORAE_MODID, "red_algae");
    public static final ResourceLocation RED_SEA_WHIP = new ResourceLocation(TFCFLORAE_MODID, "red_sea_whip");
    public static final ResourceLocation SEA_ANEMONE = new ResourceLocation(TFCFLORAE_MODID, "sea_anemone");

    // Mushrooms
    public static final ResourceLocation AMANITA = new ResourceLocation(TFCFLORAE_MODID, "amanita");
    public static final ResourceLocation BLACK_POWDERPUFF = new ResourceLocation(TFCFLORAE_MODID, "black_powderpuff");
    public static final ResourceLocation CHANTERELLE = new ResourceLocation(TFCFLORAE_MODID, "chanterelle");
    public static final ResourceLocation DEATH_CAP = new ResourceLocation(TFCFLORAE_MODID, "death_cap");
    public static final ResourceLocation GIANT_CLUB = new ResourceLocation(TFCFLORAE_MODID, "giant_club");
    public static final ResourceLocation PARASOL_MUSHROOM = new ResourceLocation(TFCFLORAE_MODID, "parasol_mushroom");
    public static final ResourceLocation STINKHORN = new ResourceLocation(TFCFLORAE_MODID, "stinkhorn");
    public static final ResourceLocation WEEPING_MILK_CAP = new ResourceLocation(TFCFLORAE_MODID, "weeping_milk_cap");
    public static final ResourceLocation WOOD_BLEWIT = new ResourceLocation(TFCFLORAE_MODID, "wood_blewit");
    public static final ResourceLocation WOOLLY_GOMPHUS = new ResourceLocation(TFCFLORAE_MODID, "woolly_gomphus");

    // Glowing Cave Mushrooms
    // public static final ResourceLocation GLOWSHROOM = new ResourceLocation(MODID, "glowshroom");

    // Large Plants
    public static final ResourceLocation BELL_TREE_DAHLIA = new ResourceLocation(TFCFLORAE_MODID, "bell_tree_dahlia");
    public static final ResourceLocation BIG_LEAF_PALM = new ResourceLocation(TFCFLORAE_MODID, "big_leaf_palm");
    public static final ResourceLocation DRAKENSBERG_CYCAD = new ResourceLocation(TFCFLORAE_MODID, "drakensberg_cycad");
    public static final ResourceLocation DWARF_SUGAR_PALM = new ResourceLocation(TFCFLORAE_MODID, "dwarf_sugar_palm");
    public static final ResourceLocation GIANT_CANE = new ResourceLocation(TFCFLORAE_MODID, "giant_cane");
    public static final ResourceLocation GIANT_ELEPHANT_EAR = new ResourceLocation(TFCFLORAE_MODID, "giant_elephant_ear");
    public static final ResourceLocation GIANT_FEATHER_GRASS = new ResourceLocation(TFCFLORAE_MODID, "giant_feather_grass");
    public static final ResourceLocation MADAGASCAR_OCOTILLO = new ResourceLocation(TFCFLORAE_MODID, "madagascar_ocotillo");
    public static final ResourceLocation MALAGASY_TREE_ALOE = new ResourceLocation(TFCFLORAE_MODID, "malagasy_tree_aloe");
    public static final ResourceLocation MOUNTAIN_CABBAGE_TREE = new ResourceLocation(TFCFLORAE_MODID, "mountain_cabbage_tree");
    public static final ResourceLocation PYGMY_DATE_PALM = new ResourceLocation(TFCFLORAE_MODID, "pygmy_date_palm");
    public static final ResourceLocation QUEEN_SAGO = new ResourceLocation(TFCFLORAE_MODID, "queen_sago");
    public static final ResourceLocation RED_SEALING_WAX_PALM = new ResourceLocation(TFCFLORAE_MODID, "red_sealing_wax_palm");
    public static final ResourceLocation SUMMER_ASPHODEL = new ResourceLocation(TFCFLORAE_MODID, "summer_asphodel");
    public static final ResourceLocation ZIMBABWE_ALOE = new ResourceLocation(TFCFLORAE_MODID, "zimbabwe_aloe");

    // Bamboo
    public static final ResourceLocation BAMBOO = new ResourceLocation(TFCFLORAE_MODID, "bamboo");
    public static final ResourceLocation ARROW_BAMBOO = new ResourceLocation(TFCFLORAE_MODID, "arrow_bamboo");
    public static final ResourceLocation BLACK_BAMBOO = new ResourceLocation(TFCFLORAE_MODID, "black_bamboo");
    public static final ResourceLocation BLUE_BAMBOO = new ResourceLocation(TFCFLORAE_MODID, "blue_bamboo");
    public static final ResourceLocation DRAGON_BAMBOO = new ResourceLocation(TFCFLORAE_MODID, "dragon_bamboo");
    public static final ResourceLocation GOLDEN_BAMBOO = new ResourceLocation(TFCFLORAE_MODID, "golden_bamboo");
    public static final ResourceLocation NARROW_LEAF_BAMBOO = new ResourceLocation(TFCFLORAE_MODID, "narrow_leaf_bamboo");
    public static final ResourceLocation RED_BAMBOO = new ResourceLocation(TFCFLORAE_MODID, "red_bamboo");
    public static final ResourceLocation TEMPLE_BAMBOO = new ResourceLocation(TFCFLORAE_MODID, "temple_bamboo");
    public static final ResourceLocation THORNY_BAMBOO = new ResourceLocation(TFCFLORAE_MODID, "thorny_bamboo");
    public static final ResourceLocation TIMBER_BAMBOO = new ResourceLocation(TFCFLORAE_MODID, "timber_bamboo");
    public static final ResourceLocation TINWA_BAMBOO = new ResourceLocation(TFCFLORAE_MODID, "tinwa_bamboo");
    public static final ResourceLocation WEAVERS_BAMBOO = new ResourceLocation(TFCFLORAE_MODID, "weavers_bamboo");

    // Plants courtesy of Therighton
    public static final ResourceLocation ANTHURIUM = new ResourceLocation(TFCFLORAE_MODID, "anthurium");
    public static final ResourceLocation ARROWHEAD = new ResourceLocation(TFCFLORAE_MODID, "arrowhead");
    public static final ResourceLocation ARUNDO = new ResourceLocation(TFCFLORAE_MODID, "arundo");
    public static final ResourceLocation AZURE_BLUET = new ResourceLocation(TFCFLORAE_MODID, "azure_bluet");
    public static final ResourceLocation BLUEGRASS = new ResourceLocation(TFCFLORAE_MODID, "bluegrass");
    public static final ResourceLocation BLUE_GINGER = new ResourceLocation(TFCFLORAE_MODID, "blue_ginger");
    public static final ResourceLocation BROMEGRASS = new ResourceLocation(TFCFLORAE_MODID, "bromegrass");
    public static final ResourceLocation BUR_MARIGOLD = new ResourceLocation(TFCFLORAE_MODID, "bur_marigold");
    public static final ResourceLocation BUR_REED = new ResourceLocation(TFCFLORAE_MODID, "bur_reed");
    public static final ResourceLocation CANNA_LILY = new ResourceLocation(TFCFLORAE_MODID, "canna_lily");
    public static final ResourceLocation COCKLESHELL_ORCHID = new ResourceLocation(TFCFLORAE_MODID, "cockleshell_orchid");
    public static final ResourceLocation DEAD_BUSH = new ResourceLocation(TFCFLORAE_MODID, "dead_bush");
    public static final ResourceLocation DESERT_FLAME = new ResourceLocation(TFCFLORAE_MODID, "desert_flame");
    public static final ResourceLocation HELICONIA = new ResourceLocation(TFCFLORAE_MODID, "heliconia");
    public static final ResourceLocation HIBISCUS = new ResourceLocation(TFCFLORAE_MODID, "hibiscus");
    public static final ResourceLocation HUNGARIAN_LILAC = new ResourceLocation(TFCFLORAE_MODID, "hungarian_lilac"); // Lilac
    public static final ResourceLocation KANGAROO_PAW = new ResourceLocation(TFCFLORAE_MODID, "kangaroo_paw");
    public static final ResourceLocation KING_FERN = new ResourceLocation(TFCFLORAE_MODID, "king_fern");
    public static final ResourceLocation LIPSTICK_PALM = new ResourceLocation(TFCFLORAE_MODID, "lipstick_palm"); // Red Sealing Wax Palm
    public static final ResourceLocation MARIGOLD = new ResourceLocation(TFCFLORAE_MODID, "marigold");
    public static final ResourceLocation MONSTERA_EPIPHYTE = new ResourceLocation(TFCFLORAE_MODID, "monstera_epiphyte");
    public static final ResourceLocation MONSTERA_GROUND = new ResourceLocation(TFCFLORAE_MODID, "monstera_ground");
    public static final ResourceLocation PHRAGMITE = new ResourceLocation(TFCFLORAE_MODID, "phragmite");
    public static final ResourceLocation PICKERELWEED = new ResourceLocation(TFCFLORAE_MODID, "pickerelweed");
    public static final ResourceLocation RADDIA_GRASS = new ResourceLocation(TFCFLORAE_MODID, "raddia_grass");
    public static final ResourceLocation SCARLET_STAR_BROMELIAD = new ResourceLocation(TFCFLORAE_MODID, "scarlet_star_bromeliad");
    public static final ResourceLocation SILVER_SPURFLOWER = new ResourceLocation(TFCFLORAE_MODID, "silver_spurflower");
    public static final ResourceLocation WATER_TARO = new ResourceLocation(TFCFLORAE_MODID, "water_taro");
