...
import static net.dries007.tfc.TerraFirmaCraft.FLORAE_MOD_ID;
...
public final class DefaultPlants
{
    ...
    // Florae
    public static final ResourceLocation CATTAIL = new ResourceLocation(FLORAE_MOD_ID, "cattail");
    public static final ResourceLocation CHAMOMILE = new ResourceLocation(FLORAE_MOD_ID, "chamomile");
    public static final ResourceLocation DEVILS_TONGUE = new ResourceLocation(FLORAE_MOD_ID, "devils_tongue");
    public static final ResourceLocation HYDRANGEA = new ResourceLocation(FLORAE_MOD_ID, "hydrangea");
    public static final ResourceLocation LAVANDULA = new ResourceLocation(FLORAE_MOD_ID, "lavandula");
    public static final ResourceLocation LEAF_LITTER = new ResourceLocation(FLORAE_MOD_ID, "leaf_litter");
    public static final ResourceLocation LILAC = new ResourceLocation(FLORAE_MOD_ID, "lilac");
    public static final ResourceLocation LILY_OF_THE_VALLEY = new ResourceLocation(FLORAE_MOD_ID, "lily_of_the_valley");
    public static final ResourceLocation MADDER = new ResourceLocation(FLORAE_MOD_ID, "madder");
    public static final ResourceLocation OCOTILLO = new ResourceLocation(FLORAE_MOD_ID, "ocotillo");
    public static final ResourceLocation PAPYRUS = new ResourceLocation(FLORAE_MOD_ID, "papyrus");
    public static final ResourceLocation PEONY = new ResourceLocation(FLORAE_MOD_ID, "peony");
    public static final ResourceLocation SHRUB = new ResourceLocation(FLORAE_MOD_ID, "shrub");
    public static final ResourceLocation CHAPARRAL_SHRUB = new ResourceLocation(FLORAE_MOD_ID, "chaparral_shrub");
    public static final ResourceLocation SUGAR_CANE = new ResourceLocation(FLORAE_MOD_ID, "sugar_cane");
    public static final ResourceLocation SUNFLOWER = new ResourceLocation(FLORAE_MOD_ID, "sunflower");
    public static final ResourceLocation TACKWEED = new ResourceLocation(FLORAE_MOD_ID, "tackweed");
    public static final ResourceLocation TAKAKIA = new ResourceLocation(FLORAE_MOD_ID, "takakia");
    public static final ResourceLocation LOW_UNDERGROWTH = new ResourceLocation(FLORAE_MOD_ID, "undergrowth_low");
    public static final ResourceLocation TROPICAL_UNDERGROWTH = new ResourceLocation(FLORAE_MOD_ID, "undergrowth_tropical");
    public static final ResourceLocation VOODOO_LILY = new ResourceLocation(FLORAE_MOD_ID, "voodoo_lily");
    public static final ResourceLocation BROMELIA_HEMISPHERICA = new ResourceLocation(FLORAE_MOD_ID, "bromelia_hemispherica");
    public static final ResourceLocation BROMELIA_LACINIOSA = new ResourceLocation(FLORAE_MOD_ID, "bromelia_laciniosa");
    public static final ResourceLocation KAIETEUR_FALLS = new ResourceLocation(FLORAE_MOD_ID, "kaieteur_falls");
    public static final ResourceLocation MATTEUCCIA = new ResourceLocation(FLORAE_MOD_ID, "matteuccia");
    public static final ResourceLocation CORD_GRASS = new ResourceLocation(FLORAE_MOD_ID, "cord_grass");
    public static final ResourceLocation REED_MANNAGRASS = new ResourceLocation(FLORAE_MOD_ID, "reed_mannagrass");
    public static final ResourceLocation PRAIRIE_JUNEGRASS = new ResourceLocation(FLORAE_MOD_ID, "prairie_junegrass");
    public static final ResourceLocation WOOLLY_BUSH = new ResourceLocation(FLORAE_MOD_ID, "woolly_bush");
    public static final ResourceLocation CINNAMON_FERN = new ResourceLocation(FLORAE_MOD_ID, "cinnamon_fern");
    public static final ResourceLocation JAPANESE_PIERIS = new ResourceLocation(FLORAE_MOD_ID, "japanese_pieris");
    public static final ResourceLocation BURNING_BUSH = new ResourceLocation(FLORAE_MOD_ID, "burning_bush");
    public static final ResourceLocation UNDERGROWTH_SHRUB = new ResourceLocation(FLORAE_MOD_ID, "undergrowth_shrub");
    public static final ResourceLocation UNDERGROWTH_SHRUB_SMALL = new ResourceLocation(FLORAE_MOD_ID, "undergrowth_shrub_small");
    public static final ResourceLocation SEA_OATS = new ResourceLocation(FLORAE_MOD_ID, "sea_oats");
    public static final ResourceLocation BUNCH_GRASS_FLOATING = new ResourceLocation(FLORAE_MOD_ID, "bunch_grass_floating");
    public static final ResourceLocation BUNCH_GRASS_REED = new ResourceLocation(FLORAE_MOD_ID, "bunch_grass_reed");
    public static final ResourceLocation CROWNGRASS = new ResourceLocation(FLORAE_MOD_ID, "crowngrass");
    public static final ResourceLocation CAT_GRASS = new ResourceLocation(FLORAE_MOD_ID, "cat_grass");
    public static final ResourceLocation GOOSEGRASS = new ResourceLocation(FLORAE_MOD_ID, "goosegrass");
    public static final ResourceLocation WHEATGRASS = new ResourceLocation(FLORAE_MOD_ID, "wheatgrass");
    public static final ResourceLocation HALFA_GRASS = new ResourceLocation(FLORAE_MOD_ID, "halfa_grass");
    public static final ResourceLocation LEYMUS = new ResourceLocation(FLORAE_MOD_ID, "leymus");
    public static final ResourceLocation MARRAM_GRASS = new ResourceLocation(FLORAE_MOD_ID, "marram_grass");
    public static final ResourceLocation SAWGRASS = new ResourceLocation(FLORAE_MOD_ID, "sawgrass");
    public static final ResourceLocation SAGUARO_CACTUS = new ResourceLocation(FLORAE_MOD_ID, "saguaro_cactus");

    public static final ResourceLocation CAVE_VINES = new ResourceLocation(FLORAE_MOD_ID, "cave_vines");
    public static final ResourceLocation GLOW_VINES = new ResourceLocation(FLORAE_MOD_ID, "glow_vines");
    public static final ResourceLocation ROOTS = new ResourceLocation(FLORAE_MOD_ID, "roots");
    public static final ResourceLocation ICICLE = new ResourceLocation(FLORAE_MOD_ID, "icicle");
    public static final ResourceLocation RESIN = new ResourceLocation(FLORAE_MOD_ID, "resin");

    // Vine/Ivy
    public static final ResourceLocation RATTAN = new ResourceLocation(FLORAE_MOD_ID, "rattan");
    public static final ResourceLocation BEARDED_MOSS = new ResourceLocation(FLORAE_MOD_ID, "bearded_moss");
    public static final ResourceLocation BLUE_SKYFLOWER = new ResourceLocation(FLORAE_MOD_ID, "blue_skyflower");
    public static final ResourceLocation GLOW_VINE = new ResourceLocation(FLORAE_MOD_ID, "glow_vine");
    public static final ResourceLocation HANGING_VINE = new ResourceLocation(FLORAE_MOD_ID, "hanging_vine");
    public static final ResourceLocation IVY = new ResourceLocation(FLORAE_MOD_ID, "ivy");
    public static final ResourceLocation JADE_VINE = new ResourceLocation(FLORAE_MOD_ID, "jade_vine");
    public static final ResourceLocation JAPANESE_IVY = new ResourceLocation(FLORAE_MOD_ID, "japanese_ivy");
    public static final ResourceLocation JUNGLE_VINE = new ResourceLocation(FLORAE_MOD_ID, "jungle_vine");
    public static final ResourceLocation LIANA = new ResourceLocation(FLORAE_MOD_ID, "liana");
    public static final ResourceLocation MADEIRA_VINE = new ResourceLocation(FLORAE_MOD_ID, "madeira_vine");
    public static final ResourceLocation MYSORE_TRUMPETVINE = new ResourceLocation(FLORAE_MOD_ID, "mysore_trumpetvine");
    public static final ResourceLocation SILVERVEIN_CREEPER = new ResourceLocation(FLORAE_MOD_ID, "silvervein_creeper");
    public static final ResourceLocation SWEDISH_IVY = new ResourceLocation(FLORAE_MOD_ID, "swedish_ivy");
    public static final ResourceLocation VARIEGATED_PERSIAN_IVY = new ResourceLocation(FLORAE_MOD_ID, "variegated_persian_ivy");

    // Epiphytes
    public static final ResourceLocation APACHE_DWARF = new ResourceLocation(FLORAE_MOD_ID, "apache_dwarf");
    public static final ResourceLocation ARTISTS_CONK = new ResourceLocation(FLORAE_MOD_ID, "artists_conk");
    public static final ResourceLocation CLIMBING_CACTUS = new ResourceLocation(FLORAE_MOD_ID, "climbing_cactus");
    public static final ResourceLocation CRIMSON_CATTLEYA = new ResourceLocation(FLORAE_MOD_ID, "crimson_cattleya");
    public static final ResourceLocation CREEPING_MISTLETOE = new ResourceLocation(FLORAE_MOD_ID, "creeping_mistletoe");
    public static final ResourceLocation CUTHBERTS_DENDROBIUM = new ResourceLocation(FLORAE_MOD_ID, "cuthberts_dendrobium");
    public static final ResourceLocation FISH_BONE_CACTUS = new ResourceLocation(FLORAE_MOD_ID, "fish_bone_cactus");
    public static final ResourceLocation FRAGRANT_FERN = new ResourceLocation(FLORAE_MOD_ID, "fragrant_fern");
    public static final ResourceLocation HARLEQUIN_MISTLETOE = new ResourceLocation(FLORAE_MOD_ID, "harlequin_mistletoe");
    public static final ResourceLocation KING_ORCHID = new ResourceLocation(FLORAE_MOD_ID, "king_orchid");
    public static final ResourceLocation LANTERN_OF_THE_FOREST = new ResourceLocation(FLORAE_MOD_ID, "lantern_of_the_forest");
    public static final ResourceLocation LARGE_FOOT_DENDROBIUM = new ResourceLocation(FLORAE_MOD_ID, "large_foot_dendrobium");
    public static final ResourceLocation COMMON_MISTLETOE = new ResourceLocation(FLORAE_MOD_ID, "common_mistletoe");
    public static final ResourceLocation SKY_PLANT = new ResourceLocation(FLORAE_MOD_ID, "sky_plant");
    public static final ResourceLocation SULPHUR_SHELF = new ResourceLocation(FLORAE_MOD_ID, "sulphur_shelf");
    public static final ResourceLocation TAMPA_BUTTERFLY_ORCHID = new ResourceLocation(FLORAE_MOD_ID, "tampa_butterfly_orchid");
    public static final ResourceLocation TURKEY_TAIL = new ResourceLocation(FLORAE_MOD_ID, "turkey_tail");
    public static final ResourceLocation WILDFIRE = new ResourceLocation(FLORAE_MOD_ID, "wildfire");
    public static final ResourceLocation SPORE_BLOSSOM = new ResourceLocation(FLORAE_MOD_ID, "spore_blossom");

    // Water Plants
    public static final ResourceLocation BADDERLOCKS = new ResourceLocation(FLORAE_MOD_ID, "badderlocks");
    public static final ResourceLocation BROWN_ALGAE = new ResourceLocation(FLORAE_MOD_ID, "brown_algae");
    public static final ResourceLocation COONTAIL = new ResourceLocation(FLORAE_MOD_ID, "coontail");
    public static final ResourceLocation EEL_GRASS = new ResourceLocation(FLORAE_MOD_ID, "eel_grass");
    public static final ResourceLocation GIANT_KELP = new ResourceLocation(FLORAE_MOD_ID, "giant_kelp");
    public static final ResourceLocation GUTWEED = new ResourceLocation(FLORAE_MOD_ID, "gutweed");
    public static final ResourceLocation HORNWORT = new ResourceLocation(FLORAE_MOD_ID, "hornwort");
    public static final ResourceLocation LAMINARIA = new ResourceLocation(FLORAE_MOD_ID, "laminaria");
    public static final ResourceLocation LEAFY_KELP = new ResourceLocation(FLORAE_MOD_ID, "leafy_kelp");
    public static final ResourceLocation MANATEE_GRASS = new ResourceLocation(FLORAE_MOD_ID, "manatee_grass");
    public static final ResourceLocation MILFOIL = new ResourceLocation(FLORAE_MOD_ID, "milfoil");
    public static final ResourceLocation PONDWEED = new ResourceLocation(FLORAE_MOD_ID, "pondweed");
    public static final ResourceLocation SAGO = new ResourceLocation(FLORAE_MOD_ID, "sago");
    public static final ResourceLocation SEAGRASS = new ResourceLocation(FLORAE_MOD_ID, "seagrass");
    public static final ResourceLocation SEAWEED = new ResourceLocation(FLORAE_MOD_ID, "seaweed");
    public static final ResourceLocation STAR_GRASS = new ResourceLocation(FLORAE_MOD_ID, "star_grass");
    public static final ResourceLocation TURTLE_GRASS = new ResourceLocation(FLORAE_MOD_ID, "turtle_grass");
    public static final ResourceLocation WINGED_KELP = new ResourceLocation(FLORAE_MOD_ID, "winged_kelp");
    public static final ResourceLocation RED_ALGAE = new ResourceLocation(FLORAE_MOD_ID, "red_algae");
    public static final ResourceLocation RED_SEA_WHIP = new ResourceLocation(FLORAE_MOD_ID, "red_sea_whip");
    public static final ResourceLocation SEA_ANEMONE = new ResourceLocation(FLORAE_MOD_ID, "sea_anemone");

    // Mushrooms
    public static final ResourceLocation AMANITA = new ResourceLocation(FLORAE_MOD_ID, "amanita");
    public static final ResourceLocation BLACK_POWDERPUFF = new ResourceLocation(FLORAE_MOD_ID, "black_powderpuff");
    public static final ResourceLocation CHANTERELLE = new ResourceLocation(FLORAE_MOD_ID, "chanterelle");
    public static final ResourceLocation DEATH_CAP = new ResourceLocation(FLORAE_MOD_ID, "death_cap");
    public static final ResourceLocation GIANT_CLUB = new ResourceLocation(FLORAE_MOD_ID, "giant_club");
    public static final ResourceLocation PARASOL_MUSHROOM = new ResourceLocation(FLORAE_MOD_ID, "parasol_mushroom");
    public static final ResourceLocation STINKHORN = new ResourceLocation(FLORAE_MOD_ID, "stinkhorn");
    public static final ResourceLocation WEEPING_MILK_CAP = new ResourceLocation(FLORAE_MOD_ID, "weeping_milk_cap");
    public static final ResourceLocation WOOD_BLEWIT = new ResourceLocation(FLORAE_MOD_ID, "wood_blewit");
    public static final ResourceLocation WOOLLY_GOMPHUS = new ResourceLocation(FLORAE_MOD_ID, "woolly_gomphus");

    // Glowing Cave Mushrooms
    // public static final ResourceLocation GLOWSHROOM = new ResourceLocation(MODID, "glowshroom");

    // Large Plants
    public static final ResourceLocation BELL_TREE_DAHLIA = new ResourceLocation(FLORAE_MOD_ID, "bell_tree_dahlia");
    public static final ResourceLocation BIG_LEAF_PALM = new ResourceLocation(FLORAE_MOD_ID, "big_leaf_palm");
    public static final ResourceLocation DRAKENSBERG_CYCAD = new ResourceLocation(FLORAE_MOD_ID, "drakensberg_cycad");
    public static final ResourceLocation DWARF_SUGAR_PALM = new ResourceLocation(FLORAE_MOD_ID, "dwarf_sugar_palm");
    public static final ResourceLocation GIANT_CANE = new ResourceLocation(FLORAE_MOD_ID, "giant_cane");
    public static final ResourceLocation GIANT_ELEPHANT_EAR = new ResourceLocation(FLORAE_MOD_ID, "giant_elephant_ear");
    public static final ResourceLocation GIANT_FEATHER_GRASS = new ResourceLocation(FLORAE_MOD_ID, "giant_feather_grass");
    public static final ResourceLocation MADAGASCAR_OCOTILLO = new ResourceLocation(FLORAE_MOD_ID, "madagascar_ocotillo");
    public static final ResourceLocation MALAGASY_TREE_ALOE = new ResourceLocation(FLORAE_MOD_ID, "malagasy_tree_aloe");
    public static final ResourceLocation MOUNTAIN_CABBAGE_TREE = new ResourceLocation(FLORAE_MOD_ID, "mountain_cabbage_tree");
    public static final ResourceLocation PYGMY_DATE_PALM = new ResourceLocation(FLORAE_MOD_ID, "pygmy_date_palm");
    public static final ResourceLocation QUEEN_SAGO = new ResourceLocation(FLORAE_MOD_ID, "queen_sago");
    public static final ResourceLocation RED_SEALING_WAX_PALM = new ResourceLocation(FLORAE_MOD_ID, "red_sealing_wax_palm");
    public static final ResourceLocation SUMMER_ASPHODEL = new ResourceLocation(FLORAE_MOD_ID, "summer_asphodel");
    public static final ResourceLocation ZIMBABWE_ALOE = new ResourceLocation(FLORAE_MOD_ID, "zimbabwe_aloe");

    // Bamboo
    public static final ResourceLocation BAMBOO = new ResourceLocation(FLORAE_MOD_ID, "bamboo");
    public static final ResourceLocation ARROW_BAMBOO = new ResourceLocation(FLORAE_MOD_ID, "arrow_bamboo");
    public static final ResourceLocation BLACK_BAMBOO = new ResourceLocation(FLORAE_MOD_ID, "black_bamboo");
    public static final ResourceLocation BLUE_BAMBOO = new ResourceLocation(FLORAE_MOD_ID, "blue_bamboo");
    public static final ResourceLocation DRAGON_BAMBOO = new ResourceLocation(FLORAE_MOD_ID, "dragon_bamboo");
    public static final ResourceLocation GOLDEN_BAMBOO = new ResourceLocation(FLORAE_MOD_ID, "golden_bamboo");
    public static final ResourceLocation NARROW_LEAF_BAMBOO = new ResourceLocation(FLORAE_MOD_ID, "narrow_leaf_bamboo");
    public static final ResourceLocation RED_BAMBOO = new ResourceLocation(FLORAE_MOD_ID, "red_bamboo");
    public static final ResourceLocation TEMPLE_BAMBOO = new ResourceLocation(FLORAE_MOD_ID, "temple_bamboo");
    public static final ResourceLocation THORNY_BAMBOO = new ResourceLocation(FLORAE_MOD_ID, "thorny_bamboo");
    public static final ResourceLocation TIMBER_BAMBOO = new ResourceLocation(FLORAE_MOD_ID, "timber_bamboo");
    public static final ResourceLocation TINWA_BAMBOO = new ResourceLocation(FLORAE_MOD_ID, "tinwa_bamboo");
    public static final ResourceLocation WEAVERS_BAMBOO = new ResourceLocation(FLORAE_MOD_ID, "weavers_bamboo");

    // Plants courtesy of Therighton
    public static final ResourceLocation ANTHURIUM = new ResourceLocation(FLORAE_MOD_ID, "anthurium");
    public static final ResourceLocation ARROWHEAD = new ResourceLocation(FLORAE_MOD_ID, "arrowhead");
    public static final ResourceLocation ARUNDO = new ResourceLocation(FLORAE_MOD_ID, "arundo");
    public static final ResourceLocation AZURE_BLUET = new ResourceLocation(FLORAE_MOD_ID, "azure_bluet");
    public static final ResourceLocation BLUEGRASS = new ResourceLocation(FLORAE_MOD_ID, "bluegrass");
    public static final ResourceLocation BLUE_GINGER = new ResourceLocation(FLORAE_MOD_ID, "blue_ginger");
    public static final ResourceLocation BROMEGRASS = new ResourceLocation(FLORAE_MOD_ID, "bromegrass");
    public static final ResourceLocation BUR_MARIGOLD = new ResourceLocation(FLORAE_MOD_ID, "bur_marigold");
    public static final ResourceLocation BUR_REED = new ResourceLocation(FLORAE_MOD_ID, "bur_reed");
    public static final ResourceLocation CANNA_LILY = new ResourceLocation(FLORAE_MOD_ID, "canna_lily");
    public static final ResourceLocation COCKLESHELL_ORCHID = new ResourceLocation(FLORAE_MOD_ID, "cockleshell_orchid");
    public static final ResourceLocation DEAD_BUSH = new ResourceLocation(FLORAE_MOD_ID, "dead_bush");
    public static final ResourceLocation DESERT_FLAME = new ResourceLocation(FLORAE_MOD_ID, "desert_flame");
    public static final ResourceLocation HELICONIA = new ResourceLocation(FLORAE_MOD_ID, "heliconia");
    public static final ResourceLocation HIBISCUS = new ResourceLocation(FLORAE_MOD_ID, "hibiscus");
    public static final ResourceLocation HUNGARIAN_LILAC = new ResourceLocation(FLORAE_MOD_ID, "hungarian_lilac"); // Lilac
    public static final ResourceLocation KANGAROO_PAW = new ResourceLocation(FLORAE_MOD_ID, "kangaroo_paw");
    public static final ResourceLocation KING_FERN = new ResourceLocation(FLORAE_MOD_ID, "king_fern");
    public static final ResourceLocation LIPSTICK_PALM = new ResourceLocation(FLORAE_MOD_ID, "lipstick_palm"); // Red Sealing Wax Palm
    public static final ResourceLocation MARIGOLD = new ResourceLocation(FLORAE_MOD_ID, "marigold");
    public static final ResourceLocation MONSTERA_EPIPHYTE = new ResourceLocation(FLORAE_MOD_ID, "monstera_epiphyte");
    public static final ResourceLocation MONSTERA_GROUND = new ResourceLocation(FLORAE_MOD_ID, "monstera_ground");
    public static final ResourceLocation PHRAGMITE = new ResourceLocation(FLORAE_MOD_ID, "phragmite");
    public static final ResourceLocation PICKERELWEED = new ResourceLocation(FLORAE_MOD_ID, "pickerelweed");
    public static final ResourceLocation RADDIA_GRASS = new ResourceLocation(FLORAE_MOD_ID, "raddia_grass");
    public static final ResourceLocation SCARLET_STAR_BROMELIAD = new ResourceLocation(FLORAE_MOD_ID, "scarlet_star_bromeliad");
    public static final ResourceLocation SILVER_SPURFLOWER = new ResourceLocation(FLORAE_MOD_ID, "silver_spurflower");
    public static final ResourceLocation WATER_TARO = new ResourceLocation(FLORAE_MOD_ID, "water_taro");
