...
public enum SeasonalTrees
{
    ...
    BAOBAB(() -> ItemsTFCF.BAOBAB_FRUIT, new int[] {0, 0, 1, 2, 2, 1, 1, 3, 4, 4, 0, 0}, 23f, 40f, 10f, 150f, 0.33f, false, false, false, DefaultTrees.BAOBAB_TREE),
    MACLURA(() -> ItemsTFCF.OSAGE_ORANGE, new int[] {0, 0, 1, 2, 2, 1, 1, 3, 4, 4, 0, 0}, -1f, 17f, 140f, 400f, 0.33f, false, false, false, DefaultTrees.MACLURA_TREE),
    MAHOGANY(() -> ItemsTFCF.SKY_FRUIT, new int[] {0, 0, 1, 2, 2, 1, 1, 3, 4, 4, 0, 0}, 23f, 42f, 220f, 500f, 0.33f, false, false, false, DefaultTrees.MAHOGANY_TREE),
    PINK_IVORY(() -> ItemsTFCF.PINK_IVORY_DRUPE, new int[] {0, 0, 1, 2, 2, 1, 1, 3, 4, 4, 0, 0}, 18f, 31f, 210f, 500f, 0.33f, false, false, false, DefaultTrees.PINK_IVORY_TREE),
    SYZYGIUM(() -> ItemsTFCF.RIBERRY, new int[] {0, 0, 1, 2, 2, 1, 1, 3, 4, 4, 0, 0}, 13f, 35f, 140f, 360f, 0.33f, false, false, false, DefaultTrees.SYZYGIUM_TREE),
    YEW(() -> ItemsTFCF.YEW_BERRY, new int[] {0, 0, 1, 2, 2, 1, 1, 3, 4, 4, 0, 0}, -15f, 11f, 180f, 350f, 0.33f, true, false, false, DefaultTrees.YEW_TREE),
    JOSHUA_TREE(() -> ItemsTFCF.BARREL_CACTUS_FRUIT, new int[] {1, 2, 2, 2, 3, 3, 3, 1, 1, 1, 1, 1}, 13f, 35f, 140f, 360f, 0.33f, false, false, true, DefaultTrees.JOSHUA_TREE_TREE),
    ...
    JUNIPER(() -> ItemsTFCF.JUNIPER, new int[] {0, 0, 1, 2, 2, 1, 1, 3, 4, 4, 0, 0}, -8f, 20f, 80f, 350f, 0.33f, false, false, false, DefaultTrees.JUNIPER_TREE),
    RED_CEDAR(() -> ItemsTFCF.JUNIPER, new int[] {0, 0, 1, 2, 2, 1, 1, 3, 4, 4, 0, 0}, -8f, 17f, 10f, 240f, 0.33f, false, false, false, DefaultTrees.RED_CEDAR_TREE),
    WHITE_CEDAR(() -> ItemsTFCF.JUNIPER, new int[] {0, 0, 1, 2, 2, 1, 1, 3, 4, 4, 0, 0}, -8f, 17f, 10f, 240f, 0.33f, false, false, false, DefaultTrees.WHITE_CEDAR_TREE),
    ...
    YELLOW_HAWTHORN(() -> ItemsTFCF.HAWTHORN, new int[] {0, 0, 1, 2, 2, 1, 1, 3, 4, 4, 0, 0}, -8f, 14f, 180f, 400f, 0.33f, true, false, false, DefaultTrees.HAWTHORN_TREE),
    ORANGE_HAWTHORN(() -> ItemsTFCF.HAWTHORN, new int[] {0, 0, 1, 2, 2, 1, 1, 3, 4, 4, 0, 0}, -8f, 14f, 180f, 400f, 0.33f, true, false, false, DefaultTrees.HAWTHORN_TREE),
    RED_HAWTHORN(() -> ItemsTFCF.HAWTHORN, new int[] {0, 0, 1, 2, 2, 1, 1, 3, 4, 4, 0, 0}, -8f, 14f, 180f, 400f, 0.33f, true, false, false, DefaultTrees.HAWTHORN_TREE),
    YELLOW_MULBERRY(() -> ItemsTFCF.HAWTHORN, new int[] {0, 0, 1, 2, 2, 1, 1, 3, 4, 4, 0, 0}, -30f, 28f, 140f, 420f, 0.33f, true, false, false, DefaultTrees.MULBERRY_TREE),
    ORANGE_MULBERRY(() -> ItemsTFCF.HAWTHORN, new int[] {0, 0, 1, 2, 2, 1, 1, 3, 4, 4, 0, 0}, -30f, 28f, 140f, 420f, 0.33f, true, false, false, DefaultTrees.MULBERRY_TREE),
    RED_MULBERRY(() -> ItemsTFCF.HAWTHORN, new int[] {0, 0, 1, 2, 2, 1, 1, 3, 4, 4, 0, 0}, -30f, 28f, 140f, 420f, 0.33f, true, false, false, DefaultTrees.MULBERRY_TREE),
    YELLOW_ROWAN(() -> ItemsTFCF.ROWAN_BERRY, new int[] {0, 0, 1, 2, 2, 1, 1, 3, 4, 4, 0, 0}, -15f, 8f, 180f, 400f, 0.33f, true, false, false, DefaultTrees.ROWAN_TREE),
    ORANGE_ROWAN(() -> ItemsTFCF.ROWAN_BERRY, new int[] {0, 0, 1, 2, 2, 1, 1, 3, 4, 4, 0, 0}, -15f, 8f, 180f, 400f, 0.33f, true, false, false, DefaultTrees.ROWAN_TREE),
    RED_ROWAN(() -> ItemsTFCF.ROWAN_BERRY, new int[] {0, 0, 1, 2, 2, 1, 1, 3, 4, 4, 0, 0}, -15f, 8f, 180f, 400f, 0.33f, true, false, false, DefaultTrees.ROWAN_TREE),
    ...
    */
    ...
    YELLOW_WHITEBEAM(() -> ItemsTFCF.ROWAN_BERRY, new int[] {0, 0, 1, 2, 2, 1, 1, 3, 4, 4, 0, 0}, -10f, 12f, 140f, 430f, 0.33f, true, false, false, DefaultTrees.WHITEBEAM_TREE),
    ORANGE_WHITEBEAM(() -> ItemsTFCF.ROWAN_BERRY, new int[] {0, 0, 1, 2, 2, 1, 1, 3, 4, 4, 0, 0}, -10f, 12f, 140f, 430f, 0.33f, true, false, false, DefaultTrees.WHITEBEAM_TREE),
    RED_WHITEBEAM(() -> ItemsTFCF.ROWAN_BERRY, new int[] {0, 0, 1, 2, 2, 1, 1, 3, 4, 4, 0, 0}, -10f, 12f, 140f, 430f, 0.33f, true, false, false, DefaultTrees.WHITEBEAM_TREE),
