...
public enum SeasonalTrees
{
    ...
    BAOBAB(() -> TFCItemFood.get(Food.BAOBAB_FRUIT), new int[] {0, 0, 1, 2, 2, 1, 1, 3, 4, 4, 0, 0}, 23f, 40f, 10f, 150f, 0.33f, false, false, false, DefaultTrees.BAOBAB_TREE),
    MACLURA(() -> TFCItemFood.get(Food.OSAGE_ORANGE), new int[] {0, 0, 1, 2, 2, 1, 1, 3, 4, 4, 0, 0}, -1f, 17f, 140f, 400f, 0.33f, false, false, false, DefaultTrees.MACLURA_TREE),
    MAHOGANY(() -> TFCItemFood.get(Food.SKY_FRUIT), new int[] {0, 0, 1, 2, 2, 1, 1, 3, 4, 4, 0, 0}, 23f, 42f, 220f, 500f, 0.33f, false, false, false, DefaultTrees.MAHOGANY_TREE),
    PINK_IVORY(() -> TFCItemFood.get(Food.PINK_IVORY_DRUPE), new int[] {0, 0, 1, 2, 2, 1, 1, 3, 4, 4, 0, 0}, 18f, 31f, 210f, 500f, 0.33f, false, false, false, DefaultTrees.PINK_IVORY_TREE),
    SYZYGIUM(() -> TFCItemFood.get(Food.RIBERRY), new int[] {0, 0, 1, 2, 2, 1, 1, 3, 4, 4, 0, 0}, 13f, 35f, 140f, 360f, 0.33f, false, false, false, DefaultTrees.SYZYGIUM_TREE),
    YEW(() -> TFCItemFood.get(Food.YEW_BERRY), new int[] {0, 0, 1, 2, 2, 1, 1, 3, 4, 4, 0, 0}, -15f, 11f, 180f, 350f, 0.33f, true, false, false, DefaultTrees.YEW_TREE),
    JOSHUA_TREE(() -> TFCItemFood.get(Food.BARREL_CACTUS_FRUIT), new int[] {1, 2, 2, 2, 3, 3, 3, 1, 1, 1, 1, 1}, 13f, 35f, 140f, 360f, 0.33f, false, false, true, DefaultTrees.JOSHUA_TREE_TREE),
    ...
    JUNIPER(() -> TFCItemFood.get(Food.JUNIPER), new int[] {0, 0, 1, 2, 2, 1, 1, 3, 4, 4, 0, 0}, -8f, 20f, 80f, 350f, 0.33f, false, false, false, DefaultTrees.JUNIPER_TREE),
    RED_CEDAR(() -> TFCItemFood.get(Food.JUNIPER), new int[] {0, 0, 1, 2, 2, 1, 1, 3, 4, 4, 0, 0}, -8f, 17f, 10f, 240f, 0.33f, false, false, false, DefaultTrees.RED_CEDAR_TREE),
    WHITE_CEDAR(() -> TFCItemFood.get(Food.JUNIPER), new int[] {0, 0, 1, 2, 2, 1, 1, 3, 4, 4, 0, 0}, -8f, 17f, 10f, 240f, 0.33f, false, false, false, DefaultTrees.WHITE_CEDAR_TREE),
    ...
    YELLOW_HAWTHORN(() -> TFCItemFood.get(Food.HAWTHORN), new int[] {0, 0, 1, 2, 2, 1, 1, 3, 4, 4, 0, 0}, -8f, 14f, 180f, 400f, 0.33f, true, false, false, DefaultTrees.HAWTHORN_TREE),
    ORANGE_HAWTHORN(() -> TFCItemFood.get(Food.HAWTHORN), new int[] {0, 0, 1, 2, 2, 1, 1, 3, 4, 4, 0, 0}, -8f, 14f, 180f, 400f, 0.33f, true, false, false, DefaultTrees.HAWTHORN_TREE),
    RED_HAWTHORN(() -> TFCItemFood.get(Food.HAWTHORN), new int[] {0, 0, 1, 2, 2, 1, 1, 3, 4, 4, 0, 0}, -8f, 14f, 180f, 400f, 0.33f, true, false, false, DefaultTrees.HAWTHORN_TREE),
    YELLOW_MULBERRY(() -> TFCItemFood.get(Food.HAWTHORN), new int[] {0, 0, 1, 2, 2, 1, 1, 3, 4, 4, 0, 0}, -30f, 28f, 140f, 420f, 0.33f, true, false, false, DefaultTrees.MULBERRY_TREE),
    ORANGE_MULBERRY(() -> TFCItemFood.get(Food.HAWTHORN), new int[] {0, 0, 1, 2, 2, 1, 1, 3, 4, 4, 0, 0}, -30f, 28f, 140f, 420f, 0.33f, true, false, false, DefaultTrees.MULBERRY_TREE),
    RED_MULBERRY(() -> TFCItemFood.get(Food.HAWTHORN), new int[] {0, 0, 1, 2, 2, 1, 1, 3, 4, 4, 0, 0}, -30f, 28f, 140f, 420f, 0.33f, true, false, false, DefaultTrees.MULBERRY_TREE),
    YELLOW_ROWAN(() -> TFCItemFood.get(Food.ROWAN_BERRY), new int[] {0, 0, 1, 2, 2, 1, 1, 3, 4, 4, 0, 0}, -15f, 8f, 180f, 400f, 0.33f, true, false, false, DefaultTrees.ROWAN_TREE),
    ORANGE_ROWAN(() -> TFCItemFood.get(Food.ROWAN_BERRY), new int[] {0, 0, 1, 2, 2, 1, 1, 3, 4, 4, 0, 0}, -15f, 8f, 180f, 400f, 0.33f, true, false, false, DefaultTrees.ROWAN_TREE),
    RED_ROWAN(() -> TFCItemFood.get(Food.ROWAN_BERRY), new int[] {0, 0, 1, 2, 2, 1, 1, 3, 4, 4, 0, 0}, -15f, 8f, 180f, 400f, 0.33f, true, false, false, DefaultTrees.ROWAN_TREE),
    YELLOW_PINK_CHERRY(() -> TFCItemFood.get(Food.CHERRY), new int[] {0, 0, 0, 2, 2, 1, 1, 3, 4, 4, 0, 0}, 0f, 20f, 180f, 300f, 0.33f, true, false, false, DefaultTrees.PINK_CHERRY_TREE),
    ORANGE_PINK_CHERRY(() -> TFCItemFood.get(Food.CHERRY), new int[] {0, 0, 0, 2, 2, 1, 1, 3, 4, 4, 0, 0}, 0f, 20f, 180f, 300f, 0.33f, true, false, false, DefaultTrees.PINK_CHERRY_TREE),
    RED_PINK_CHERRY(() -> TFCItemFood.get(Food.CHERRY), new int[] {0, 0, 0, 0, 2, 1, 1, 3, 4, 4, 0, 0}, 0f, 20f, 180f, 300f, 0.33f, true, false, false, DefaultTrees.PINK_CHERRY_TREE),
    YELLOW_WHITE_CHERRY(() -> TFCItemFood.get(Food.CHERRY), new int[] {0, 0, 0, 2, 2, 1, 1, 3, 4, 4, 0, 0}, 0f, 20f, 180f, 300f, 0.33f, true, false, false, DefaultTrees.WHITE_CHERRY_TREE),
    ORANGE_WHITE_CHERRY(() -> TFCItemFood.get(Food.CHERRY), new int[] {0, 0, 0, 2, 2, 1, 1, 3, 4, 4, 0, 0}, 0f, 20f, 180f, 300f, 0.33f, true, false, false, DefaultTrees.WHITE_CHERRY_TREE),
    RED_WHITE_CHERRY(() -> TFCItemFood.get(Food.CHERRY), new int[] {0, 0, 0, 0, 2, 1, 1, 3, 4, 4, 0, 0}, 0f, 20f, 180f, 300f, 0.33f, true, false, false, DefaultTrees.WHITE_CHERRY_TREE),
    ...
    */
    ...
    YELLOW_WHITEBEAM(() -> TFCItemFood.get(Food.ROWAN_BERRY), new int[] {0, 0, 1, 2, 2, 1, 1, 3, 4, 4, 0, 0}, -10f, 12f, 140f, 430f, 0.33f, true, false, false, DefaultTrees.WHITEBEAM_TREE),
    ORANGE_WHITEBEAM(() -> TFCItemFood.get(Food.ROWAN_BERRY), new int[] {0, 0, 1, 2, 2, 1, 1, 3, 4, 4, 0, 0}, -10f, 12f, 140f, 430f, 0.33f, true, false, false, DefaultTrees.WHITEBEAM_TREE),
    RED_WHITEBEAM(() -> TFCItemFood.get(Food.ROWAN_BERRY), new int[] {0, 0, 1, 2, 2, 1, 1, 3, 4, 4, 0, 0}, -10f, 12f, 140f, 430f, 0.33f, true, false, false, DefaultTrees.WHITEBEAM_TREE),
