...
public class TreeFamilyDynamic extends TreeFamily
{
    ...
    public TreeFamilyDynamic(ResourceLocation name, Tree tree)
    {
        super(name);
    ...
    {
        BlockLogDynamic primLogBlock = (BlockLogDynamic) primLog.getBlock();
    ...
    {
        public TreeTFCSpecies(TreeFamilyDynamic treeFamily, LeavesProperties prop)
        {
