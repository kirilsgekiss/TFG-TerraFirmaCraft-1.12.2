...
public class BiomeMesaTFC extends BiomeTFC
{
    ...
    public BiomeMesaTFC(boolean hasBrycePillars, boolean hasForest, int debugColor, BiomeProperties properties)
    {
        this(hasBrycePillars, hasForest, debugColor, properties, 0, 0);
    }

    public BiomeMesaTFC(boolean hasBrycePillars, boolean hasForest, int debugColor, BiomeProperties properties, int lilyPadPerChunk, int waterPlantsPerChunk)
    {
